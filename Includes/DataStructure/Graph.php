...
class Graph
{
     ...
     */
    public const ROOT_NODE_KEY = '____ROOT____';
    ...
    {
        return ($key ?: $this->getKey()) === static::ROOT_NODE_KEY;
    }
    ...
    public function walkThrough($callback, $invert = false, \Includes\DataStructure\Graph $parent = null, $isStarted = false)
    {
        ...
        if ($isStarted && $invert) {
            call_user_func_array($callback, [$this, $parent]);
        }
    ...
    public function walkFirst($callback, \Includes\DataStructure\Graph $parent = null, $isStarted = false)
    {
        ...
        // Condition to avoid callback on the root node
        if ($isStarted) {
            $result = call_user_func_array($callback, [$this, $parent]);
        }
    ...
    public function findAll($key = null)
    {
        ...
        $this->walkThrough(
            static function (\Includes\DataStructure\Graph $node) use ($key, &$searchResult) {
