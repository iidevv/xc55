...
StickyPanelModelList.prototype.handleAnyItemsSelected = function () {
  this.base.find('button.action-enable span').last().text(xcart.t('Enable selected'));
  this.base.find('button.action-disable span').last().text(xcart.t('Disable selected'));
};

StickyPanelModelList.prototype.handleNoSelectedItems = function () {
  this.base.find('button.action-enable span').last().text(xcart.t('Enable all'));
  this.base.find('button.action-disable span').last().text(xcart.t('Disable all'));
};
