...
xcart.microhandlers.add(
  ...
  function (event) {
    ...
    var sticky = form.find('.sticky-panel');
    if (jQuery(this).css('display') == 'none') {
      ...
      (sticky.length && sticky.get(0).controller) ? sticky.get(0).controller.unmarkAsChanged() : null;
    }
  }
);
...
xcart.microhandlers.add(
  ...
  function () {
    xcart.autoload(StickyPanelModelList);
  }
);
