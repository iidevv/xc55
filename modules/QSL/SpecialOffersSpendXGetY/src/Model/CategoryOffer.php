 ...
 *
 * @ORM\Entity
 * @ORM\Table (name="sxgy_category_offers",
 *      uniqueConstraints={
...
class CategoryOffer extends \XLite\Model\AEntity
{
     ...
     *
     * @ORM\ManyToOne  (targetEntity="XLite\Model\Category", inversedBy="xgyCategoryOffers")
     ...
     * @var \Doctrine\Common\Collections\ArrayCollection
     *
     * @ORM\ManyToOne  (targetEntity="QSL\SpecialOffersBase\Model\SpecialOffer", inversedBy="sxgyConditionCategories")
