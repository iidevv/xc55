...
use QSL\LoyaltyProgram\API\Endpoint\Profile\DTO\ProfileInput as ModuleInputDTO;
...
class InputTransformer extends ExtendedInputTransformer
{
    ...
    public function transform($object, string $to, array $context = []): BaseModel
    {
        ...
        $entity->setRewardPoints($object->reward_points);
    ...
    public function initialize(string $inputClass, array $context = [])
    {
        ...
        $input->reward_points = $entity->getRewardPoints();
