 ...
 * Foursquare wrapper
 */
class Foursquare extends \QSL\OAuth2Client\Core\Wrapper\AWrapper
{
    /**
     * @inheritdoc
     */
    ...
    {
        return new \Stevenmaguire\OAuth2\Client\Provider\Foursquare(
            [
    ...
    protected function normalizeUser(\League\OAuth2\Client\Provider\ResourceOwnerInterface $resource, \League\OAuth2\Client\Token\AccessToken $token)
    {
        ...
        if ($resource instanceof \Stevenmaguire\OAuth2\Client\Provider\FoursquareResourceOwner) {
            /** @var \Stevenmaguire\OAuth2\Client\Provider\FoursquareResourceOwner $resource */
