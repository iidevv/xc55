...
namespace QSL\BraintreeVZ\View\Form\Payment\Method\Admin;
 ...
 * @Extender\Mixin
 */
class Settings extends \XLite\View\Form\Payment\Method\Admin\Settings
{
    /**
     * Is Braintree flag 
     */
    ...
    protected function isBraintreePaymentMethod()
    {
        if (is_null($this->isBraintree)) {
            ...
            $this->isBraintree = $paymentMethod
                && (\QSL\BraintreeVZ\Core\BraintreeClient::BRAINTREE_CLASS == $paymentMethod->getClass());
        }
