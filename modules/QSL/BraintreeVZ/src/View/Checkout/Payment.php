...
namespace QSL\BraintreeVZ\View\Checkout;
...
abstract class Payment extends \XLite\View\Checkout\Payment
{
    ...
    protected function isIncludeBraintreeFiles()
    {
        if (null === $this->includeBraintreeFiles) {
            ...
            $client = \QSL\BraintreeVZ\Core\BraintreeClient::getInstance();
    ...
    public function getJSFiles()
    {
        ...
        if ($this->isIncludeBraintreeFiles()) {
            ...
            $client = \QSL\BraintreeVZ\Core\BraintreeClient::getInstance();
            $version = \QSL\BraintreeVZ\Core\BraintreeClient::BRAINTREE_JS_VERSION;
    ...
    {
        return \QSL\BraintreeVZ\Core\BraintreeClient::getInstance()->getPaymentMethod()->getMethodId();
    }
    ...
    {
        return '1' == \QSL\BraintreeVZ\Core\BraintreeClient::getInstance()->getSetting('isPayPal');
    }
    ...
    {
        return '1' == \QSL\BraintreeVZ\Core\BraintreeClient::getInstance()->getSetting('isApplePay');
    }
    ...
    {
        return '1' == \QSL\BraintreeVZ\Core\BraintreeClient::getInstance()->getSetting('isGooglePay');
    }
    ...
    public function isShowSaveCardBox()
    {
        return \XLite\Core\Auth::getInstance()->isLogged()
            && \QSL\BraintreeVZ\Core\BraintreeClient::getInstance()->getSetting('isUseVault')
            && (bool)\QSL\BraintreeVZ\Core\BraintreeClient::getInstance()->getSetting('isShowSaveCardBox');
    }
