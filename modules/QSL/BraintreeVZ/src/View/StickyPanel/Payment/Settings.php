...
namespace QSL\BraintreeVZ\View\StickyPanel\Payment;
 ...
 * @Extender\Mixin
 */
class Settings extends \XLite\View\StickyPanel\Payment\Settings
{
    /**
    ...
    {
        return \QSL\BraintreeVZ\Core\BraintreeClient::getInstance()->getPaymentMethod();
    }
