...
class BraintreeClient extends \XLite\Base\Singleton
{
     ...
     */
    const BRAINTREE_CLASS = 'QSL\BraintreeVZ\Model\Payment\Processor\BraintreeVZ';
    ...
    protected function getInitRequest(\XLite\Model\Payment\Transaction $transaction)
    {
        ...
        $request = array(
            ...
            'options' => array(
                ...
                'storeInVaultOnSuccess' => \QSL\BraintreeVZ\Core\BraintreeClient::getInstance()->getSetting('isUseVault'),
            ),
        ...
        if (static::IS_DEBUG) {
            ...
            static::getStaticLogger('QSL-BraintreeVZ')->debug($logMessage);
        }
    ...
    public static function processError($error = null)
    {
        ...
        static::getStaticLogger('QSL-BraintreeVZ')->error($logMessage);
