...
namespace QSL\BraintreeVZ\Model\Payment;
...
class Transaction extends \XLite\Model\Payment\Transaction
{
    ...
    public function setBraintreeDataCell($field, $value, $title, $fieldPrefix = '', $titlePrefix = '', $titlePostfix = '')
    {
        ...
        if ($value instanceof \DateTime) {
            $value->setTimezone(\QSL\BraintreeVZ\Core\BraintreeClient::getInstance()->getStoreTimeZone());
    ...
    public function isBraintreeTransaction()
    {
        return $this->getPaymentMethod()
            && \QSL\BraintreeVZ\Core\BraintreeClient::BRAINTREE_CLASS == $this->getPaymentMethod()->getClass();
    }
