...
namespace QSL\BraintreeVZ\Model\Payment\Processor;
...
class BraintreeVZ extends \XLite\Model\Payment\Base\CreditCard
{
    ...
    {
        return '\QSL\BraintreeVZ\View\Tabs\Config';
    }
    ...
    {
        return \QSL\BraintreeVZ\Core\BraintreeClient::getInstance()->isConfigured();
    }
    ...
    {
        $result = \QSL\BraintreeVZ\Core\BraintreeClient::getInstance()
            ->processCapture(
    ...
    protected function doInitialpayment()
    {
        ...
        $braintreeResult = \QSL\BraintreeVZ\Core\BraintreeClient::getInstance()->processCheckout($this->transaction);
