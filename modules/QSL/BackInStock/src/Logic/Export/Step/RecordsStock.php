 ...
 */
class RecordsStock extends \XLite\Logic\Export\Step\AStep
{
    // {{{ Data
     ...
     * @return string
     */
    protected function getQuantityColumnValue(array $dataset, $name, $i)
    {
        return $this->getColumnValueByName($dataset['model'], 'quantity');
    }
