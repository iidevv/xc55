...
namespace QSL\Returns\View\Button\Customer\ModifyReturn;
...
class Submit extends \XLite\View\Button\Regular
{
    ...
    protected function getDefaultJSCode()
    {
        ...
        $code = 'if (!$(\'div.return-box input[name^="select"]:visible:checked\').length) { alert(\'' . $this->getDefaultInfoText() . '\')} else {' . $code . '}';
