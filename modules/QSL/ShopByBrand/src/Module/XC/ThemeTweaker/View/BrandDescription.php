 ...
 */
class BrandDescription extends \QSL\ShopByBrand\View\BrandDescription implements ThemeTweaker\View\LayoutBlockInterface
{
    ...
    {
        return static::t('Brand description');
    }
}
