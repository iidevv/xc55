...
namespace QSL\SpecialOffersBuyXGetY\View\ItemsList\Promotions;
...
class CategoryOffers extends \QSL\SpecialOffersBase\View\ItemsList\Promotions\CategoryOffers
{
    ...
    protected function getSearchCondition()
    {
        ...
        $cnd->{\QSL\SpecialOffersBase\Model\Repo\SpecialOffer::SEARCH_VISIBLE_BXGY_CATEGORY} = true;
        $cnd->{\QSL\SpecialOffersBase\Model\Repo\SpecialOffer::SEARCH_ENABLED_BXGY_CATEGORY} = intval($this->getCategory()->getCategoryId());
