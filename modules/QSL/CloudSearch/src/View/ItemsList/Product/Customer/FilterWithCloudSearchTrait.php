...
use QSL\CloudSearch\View\ItemsList\Product\ListItem;
...
trait FilterWithCloudSearchTrait
{
    ...
    public function getSearchCondition()
    {
        ...
        if ($this->isLoadingWithCloudSearch($cnd)) {
            if (
                Container::getContainer()->get(ModuleManagerDomain::class)->isEnabled('XC-ProductVariations')
                && isset($cnd->{\XC\ProductVariations\Model\Repo\Product::P_IS_HIDDEN})
            ) {
                unset($cnd->{\XC\ProductVariations\Model\Repo\Product::P_IS_HIDDEN});
            }
