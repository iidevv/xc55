...
/**
 * @ListChild(list="gdpr-activities", zone="admin", weight="3000")
 */
class Payment extends \XC\GDPR\View\ItemsList\Model\AActivity
{
    protected function getMainHeadTitle()
    {
        return static::t('Gdpr Payments');
    }
    ...
    protected function getSearchCondition()
    {
        ...
        $cnd->{ActivityRepo::PARAM_TYPE} = Activity::TYPE_PAYMENT;
