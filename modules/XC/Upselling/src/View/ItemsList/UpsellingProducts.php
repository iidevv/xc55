...
namespace XC\Upselling\View\ItemsList;
...
class UpsellingProducts extends \XLite\View\ItemsList\Product\Customer\ACustomer
{
     ...
     * Widget target
     */
    public const WIDGET_TARGET_PRODUCT = 'product';
    ...
    {
        return [
            \XC\Upselling\Model\Repo\UpsellingProduct::SEARCH_PARENT_PRODUCT_ID => self::PARAM_PRODUCT_ID,
        ];
    }
    ...
    protected function getData(\XLite\Core\CommonCell $cnd, $countOnly = false)
    {
        ...
        if (!$countOnly) {
            return array_map(static function ($item) {
                /** @var \XC\Upselling\Model\UpsellingProduct $item  */
