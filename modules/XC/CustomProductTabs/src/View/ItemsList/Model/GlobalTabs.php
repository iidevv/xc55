...
namespace XC\CustomProductTabs\View\ItemsList\Model;
...
class GlobalTabs extends \XLite\View\ItemsList\Model\Table
{
    ...
    protected function defineColumns()
    {
        return [
            'enabled' => [
                static::COLUMN_NAME  => \XLite\Core\Translation::lbl('Show'),
     ...
     * Check if tab global
     *
     * @param \XC\CustomProductTabs\Model\Product\GlobalTab $entity Entity
     *
     * @return bool
     */
    ...
    /**
     * @param \XC\CustomProductTabs\Model\Product\GlobalTab $model
     *
     * @return string
     */
    ...
    {
        return array_filter(array_map(static function (GlobalTabProvider $provider) {
            ...
            if (Manager::getRegistry()->isModuleEnabled($code)) {
                return sprintf(
                    ...
                    Manager::getRegistry()->getModule($code)['moduleName']
                );
            }
    ...
    {
        return 'XC\CustomProductTabs\View\StickyPanel\ItemsList\GlobalTab';
    }
}
