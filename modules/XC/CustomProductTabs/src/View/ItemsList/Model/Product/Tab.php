...
namespace XC\CustomProductTabs\View\ItemsList\Model\Product;
...
class Tab extends \XLite\View\ItemsList\Model\Table
{
    ...
    public function getCSSFiles()
    {
        ...
        $list[] = 'modules/XC/CustomProductTabs/product_tabs/style.less';
     ...
     * Check if tab global
     *
     * @param \XC\CustomProductTabs\Model\Product\Tab $entity Entity
     *
     * @return bool
     */
    ...
    {
        return 'XC\CustomProductTabs\View\StickyPanel\ItemsList\Product\Tab';
    }
