...
class Tab extends \XLite\View\Model\AModel
{
    ...
    protected $schemaDefault = [
        ...
        'contentTab' => [
            self::SCHEMA_CLASS                                   => '\XC\CustomProductTabs\View\FormField\Textarea\Description',
        ...
        'brief_info' => [
            self::SCHEMA_CLASS => '\XC\CustomProductTabs\View\FormField\Textarea\BriefInfo',
    ...
    {
        $repo = \XLite\Core\Database::getRepo('XC\CustomProductTabs\Model\Product\Tab');
        $model = $this->getModelId()
            ? $repo->find($this->getModelId())
            : null;

        return $model ?: new \XC\CustomProductTabs\Model\Product\Tab();
    }
    ...
    {
        return '\XC\CustomProductTabs\View\Form\Model\Product\Tab';
    }
