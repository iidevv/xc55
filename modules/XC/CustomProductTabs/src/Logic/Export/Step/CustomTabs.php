...
namespace XC\CustomProductTabs\Logic\Export\Step;
...
class CustomTabs extends \XLite\Logic\Export\Step\Base\I18n
{
    ...
    {
        return \XLite\Core\Database::getRepo('XC\CustomProductTabs\Model\Product\Tab');
    }
    ...
    protected function getUsedLanguageCodes()
    {
        ...
        if (empty($codes)) {
            $codes = \XLite\Core\Database::getRepo('XC\CustomProductTabs\Model\Product\CustomGlobalTab')
