...
namespace XC\CustomProductTabs\Logic\Import\Processor;
...
class GlobalTabs extends \XLite\Logic\Import\Processor\AProcessor
{
    ...
    {
        return strpos($file->getFilename(), 'global-product-tabs') === 0;
    }
    ...
    protected function createModel(array $data)
    {
        ...
        if (empty($data['service_name'])) {
            $customTab = Database::getRepo('XC\CustomProductTabs\Model\Product\CustomGlobalTab')->insert(null, false);
