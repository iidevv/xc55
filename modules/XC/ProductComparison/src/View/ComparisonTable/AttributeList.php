 ...
 * Attribute list
 */
class AttributeList extends \XC\ProductComparison\View\ComparisonTable\AComparisonTable
{
    /**
     * Widget param names
     */
    ...
    protected function getAttributesList($countOnly = false)
    {
        ...
        $cnd->product = null;
        $cnd->type = [\XLite\Model\Attribute::TYPE_CHECKBOX,\XLite\Model\Attribute::TYPE_SELECT,\XLite\Model\Attribute::TYPE_TEXT];
            ...
            switch ($attribute->getType()) {
                case $attribute::TYPE_CHECKBOX:
                    ...
                    if (
                        ...
                        $result = '<div class="product-tick">✔</div>';
                    } else {
                        $result = '&mdash;';
                    }
                    break;
