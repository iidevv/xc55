 ...
 */
class FeatureComparisonCheckboxValues extends \XLite\Logic\Import\Processor\AttributeValues\AttributeValueCheckbox
{
    ...
    public static function defineDataset()
    {
        ...
        $id_generator_place_holder = static::GENERATOR_PLACEHOLDER;
