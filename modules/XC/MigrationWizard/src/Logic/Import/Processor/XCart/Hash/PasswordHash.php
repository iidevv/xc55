...
namespace XC\MigrationWizard\Logic\Import\Processor\XCart\Hash;

use XC\MigrationWizard\Logic\Import\Processor\XCart\Hash\Base;
...
class PasswordHash extends Base
{
    ...
    public function get_random_bytes($count)
    {
        ...
        if (
            strlen($output) != $count && LC_OS_IS_WIN && class_exists('COM')
        ) {
            try {
