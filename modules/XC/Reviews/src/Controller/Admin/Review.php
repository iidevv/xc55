...
class Review extends \XLite\Controller\Admin\AAdmin
{
    ...
    {
        $result = \XLite\Core\Database::getRepo('\XC\Reviews\Model\Review')->find($this->getId());

        return $result ? : new \XC\Reviews\Model\Review();
    }
    ...
    {
        $this->getModelForm()->getModelObject()->setStatus(\XC\Reviews\Model\Review::STATUS_APPROVED);
        $this->doActionModify();
    }
    ...
    {
        return 'XC\Reviews\View\Model\Review';
    }
}
