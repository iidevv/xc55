...
namespace XC\Reviews\View\Customer\ProductInfo\ItemsList;
 ...
 * Reviews list widget
 */
class AverageRating extends \XC\Reviews\View\AverageRating implements DynamicWidgetInterface
{
    use CacheableTrait;
    ...
    protected function getCacheParameters()
    {
        ...
        $list[] = Database::getRepo('XC\Reviews\Model\Review')->getVersion();
