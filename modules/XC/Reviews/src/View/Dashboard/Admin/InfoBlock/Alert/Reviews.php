...
namespace XC\Reviews\View\Dashboard\Admin\InfoBlock\Alert;
...
class Reviews extends \XLite\View\Dashboard\Admin\InfoBlock\AAlert
{
     ...
     */
    public const MAX_REVIEWS_COUNT = 100;
    ...
    protected function getCounter()
    {
        if ($this->reviewsCount === null) {
            $this->reviewsCount = \XLite\Core\Database::getRepo('XC\Reviews\Model\Review')->search(
    ...
    protected function getReviewsSearchParams()
    {
        ...
        $cnd->{\XC\Reviews\Model\Repo\Review::SEARCH_NEW} = 1;
        $cnd->{\XC\Reviews\Model\Repo\Review::P_LIMIT}    = [0, static::MAX_REVIEWS_COUNT];
