...
use XC\Reviews\View\StickyPanel\ItemsList\ProductReview as ProductReviewPanel;

/**
 * Reviews list for tab in product details page
 *
 */
class ProductReview extends \XC\Reviews\View\ItemsList\Model\Review
{
    /**
     * Widget param names
     */
    ...
    {
        return ProductReviewPanel::class;
    }
    ...
    protected function getSearchCondition()
    {
        ...
        $result->{\XC\Reviews\Model\Repo\Review::SEARCH_PRODUCT} = $this->getProductId();
    ...
    protected function isClassColumnVisible(array $column, \XLite\Model\AEntity $entity)
    {
        ...
        if ($column[static::COLUMN_CODE] ==  'useForMeta') {
