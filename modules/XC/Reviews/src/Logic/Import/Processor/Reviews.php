...
namespace XC\Reviews\Logic\Import\Processor;
...
class Reviews extends \XLite\Logic\Import\Processor\AProcessor
{
     ...
     * Import 'email' value
     *
     * @param \XC\Reviews\Model\Review $model  Review
     * @param string                                $value  Value
     * @param array                                 $column Column info
     *
     * @return void
     */
    protected function importEmailColumn(\XC\Reviews\Model\Review $model, $value, array $column)
    {
     ...
     * @return void
     */
    protected function importRespondentColumn(\XC\Reviews\Model\Review $model, $value, array $column)
    {
        if ($value && $profile = $this->normalizeValueAsProfile($value)) {
