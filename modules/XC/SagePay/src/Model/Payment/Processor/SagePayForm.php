...
namespace XC\SagePay\Model\Payment\Processor;
...
class SagePayForm extends \XLite\Model\Payment\Base\WebBased
{
    ...
    public const THOUSAND_DELIMITER = ',';
    ...
    public function processReturn(\XLite\Model\Payment\Transaction $transaction)
    {
        ...
        $this->getLogger('XC-SagePay')->error('processReturnRawResult', [
            'data' => $request->getData()
        ]);

        $this->getLogger('XC-SagePay')->error('processReturn', [
            'data' => $requestBody
        ]);
