...
namespace XC\ThemeTweaker\View\FormField\Select;
...
{
    public const PARAM_LAYOUT_GROUP = 'group';
    ...
    protected function getOptions()
    {
        ...
        $availableTypes = $groupTypes[$currentGroup] ?? $groupTypes[Layout::LAYOUT_GROUP_DEFAULT];
