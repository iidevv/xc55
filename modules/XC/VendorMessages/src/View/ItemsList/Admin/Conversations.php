...
namespace XC\VendorMessages\View\ItemsList\Admin;
 ...
 * Conversations
 */
class Conversations extends \XC\VendorMessages\View\ItemsList\Conversations
{
    /**
     * Widget param names
     */
    public const PARAM_SEARCH_MESSAGES          = 'messages';
    public const PARAM_SEARCH_MESSAGE_SUBSTRING = 'messageSubstring';
