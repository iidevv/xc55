...
namespace XC\Stripe\API\Endpoint\Profile\Transformer;
...
use XC\Stripe\API\Endpoint\Profile\DTO\ProfileInput as ModuleInputDTO;
use XC\Stripe\API\Endpoint\Profile\DTO\ProfileOutput as ModuleOutputDTO;
use XC\Stripe\Model\Profile as Model;
...
class InputTransformer extends ExtendedInputTransformer
{
    ...
    public function transform($object, string $to, array $context = []): BaseModel
    {
        ...
        $entity->setStripeCustomerId($object->stripe_customer_id);
    ...
    public function initialize(string $inputClass, array $context = [])
    {
        ...
        $input->stripe_customer_id = $entity->getStripeCustomerId();
