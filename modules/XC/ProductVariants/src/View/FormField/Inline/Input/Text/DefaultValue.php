...
class DefaultValue extends \XLite\View\FormField\Inline\Input\Text
{
    ...
    {
        return parent::getFieldParams($field) + ['min' => 0, 'mouseWheelIcon' => false, 'placeholder' => $this->getPlaceholder()];
    }
    ...
    public function saveValue()
    {
        foreach ($this->getFields() as $field) {
            ...
            $method = 'setDefault' . \Includes\Utils\Converter::convertToUpperCamelCase($field['field'][static::FIELD_NAME]);
