...
namespace XC\NewsletterSubscriptions\View\ItemsList;
...
class Subscribers extends \XLite\View\ItemsList\Model\Table
{
    ...
    {
        return 'XC\NewsletterSubscriptions\View\StickyPanel\Subscribers';
    }
    ...
    protected function prevalidateNewEntity(\XLite\Model\AEntity $entity)
    {
        ...
        if ($validated) {
            $exists = \XLite\Core\Database::getRepo('XC\NewsletterSubscriptions\Model\Subscriber')
