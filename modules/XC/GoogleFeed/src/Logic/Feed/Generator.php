...
namespace XC\GoogleFeed\Logic\Feed;
...
class Generator extends AGenerator
{
    ...
    /**
     * @var \XC\GoogleFeed\Core\Task\FeedUpdater
     */
    ...
    protected function initialize()
    {
        if (!FileManager::isExists(LC_DIR_DATA)) {
            ...
            if (!FileManager::isExists(LC_DIR_DATA)) {
                ...
                $this->getLogger('XC-GoogleFeed')->error($message);
    ...
    {
        return [
            'XC\GoogleFeed\Logic\Feed\Step\Products',
        ];
    }
...
HEAD;
    ...
    public function generate()
    {
        ...
        do {
            \XC\GoogleFeed\Core\EventListener\FeedGeneration::getInstance()->unsetGenerator();
