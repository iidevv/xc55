...
namespace XC\CanadaPost\View\FormField\Inline;

/**
 * Canada Post return status
 */
class ReturnStatus extends \XLite\View\FormField\Inline\Base\Single
{
    /**
     * Define form field
     *
    ...
    {
        return 'XC\CanadaPost\View\FormField\Select\ReturnStatus';
    }
    ...
    {
        $list = \XC\CanadaPost\Model\ProductsReturn::getAllowedStatuses();
