...
namespace XC\CanadaPost\Model\Repo\Base;
...
abstract class Storage extends \XLite\Model\Repo\Base\Storage
{
    ...
    protected function defineStorageRepositories()
    {
        ...
        $list[] = 'XC\CanadaPost\Model\Order\Parcel\Shipment\Link\Storage';
        $list[] = 'XC\CanadaPost\Model\Order\Parcel\Manifest\Link\Storage';
