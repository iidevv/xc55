...
namespace XC\CanadaPost\Model\Order\Parcel\Manifest\Link;
 ...
 *
 * @ORM\Entity
 * @ORM\Table  (name="order_capost_parcel_manifest_link_storage")
 */
class Storage extends \XLite\Model\Base\Storage
{
     ...
     * Relation to a link
     *
     * @var \XC\CanadaPost\Model\Order\Parcel\Manifest\Link
     *
     * @ORM\OneToOne   (targetEntity="XC\CanadaPost\Model\Order\Parcel\Manifest\Link", inversedBy="storage")
     ...
     * Set link
     *
     * @param \XC\CanadaPost\Model\Order\Parcel\Manifest\Link $link Link object (OPTIONAL)
     *
     * @return void
     */
    public function setLink(\XC\CanadaPost\Model\Order\Parcel\Manifest\Link $link = null)
    {
        $this->link = $link;
    }
     ...
     * Get link
     *
     * @return \XC\CanadaPost\Model\Order\Parcel\Manifest\Link
     */
