 ...
 *
 * @ORM\Entity
 * @ORM\Table  (name="order_capost_parcel_shipment_tracking_events")
 */
class SignificantEvent extends \XLite\Model\AEntity
{
     ...
     *
     * @ORM\ManyToOne  (targetEntity="XC\CanadaPost\Model\Order\Parcel\Shipment\Tracking", inversedBy="significantEvents")
     ...
     * @var string
     *
     * @ORM\Column (type="string", options={ "fixed": true }, length=10)
     */
    protected $date;
