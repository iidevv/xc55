...
namespace XC\CanadaPost\Model\Order\Parcel\Shipment\Link;
 ...
 *
 * @ORM\Entity
 * @ORM\Table  (name="order_capost_parcel_shipment_link_storage")
 */
class Storage extends \XLite\Model\Base\Storage
{
     ...
     * Relation to a link
     *
     * @var \XC\CanadaPost\Model\Order\Parcel\Shipment\Link
     *
     * @ORM\OneToOne   (targetEntity="XC\CanadaPost\Model\Order\Parcel\Shipment\Link", inversedBy="storage")
     ...
     * Set link
     *
     * @param \XC\CanadaPost\Model\Order\Parcel\Shipment\Link $link Link object (OPTIONAL)
     *
     * @return void
     */
    public function setLink(\XC\CanadaPost\Model\Order\Parcel\Shipment\Link $link = null)
    {
        $this->link = $link;
    }
     ...
     * Get link
     *
     * @return \XC\CanadaPost\Model\Order\Parcel\Shipment\Link
     */
