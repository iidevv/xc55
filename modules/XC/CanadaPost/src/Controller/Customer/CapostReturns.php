...
class CapostReturns extends \XLite\Controller\Customer\ACustomer
{
     ...
     * @var array
     */
    protected $params = ['target', 'order_number', 'order_id'];
    ...
    protected function addBaseLocation()
    {
        ...
        $this->addLocationNode(
            'Order details',
            $this->buildURL('order', '', ['order_number' => $this->getOrder()->getOrderNumber()])
        );
    }
    ...
    protected function doActionCreateReturn()
    {
        ...
        if (!empty($items)) {
            ...
            $returnRequest = new \XC\CanadaPost\Model\ProductsReturn();
            ...
            foreach ($items as $itemId => $itemData) {
                ...
                $returnItem = new \XC\CanadaPost\Model\ProductsReturn\Item();
