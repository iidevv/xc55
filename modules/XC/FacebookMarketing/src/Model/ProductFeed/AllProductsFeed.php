 ...
 * AllProductsFeed
 */
class AllProductsFeed implements \XC\FacebookMarketing\Model\ProductFeed\IProductFeed
{
    use \XLite\Core\Cache\ExecuteCachedTrait;

    public const FIELD_PARAM_NAME            = 'name';
    public const FIELD_PARAM_GETTER          = 'getter';
    public const PARAM_PRODUCT_GETTER_PREFIX = 'getEntityData';
    ...
    {
        return \XC\FacebookMarketing\Core\ProductFeedDataWriter::getDataDir()
    ...
    protected function isNeedDefaultMpn($entity)
    {
        foreach ($this->getHeaders() as $header) {
            if (in_array($header[static::FIELD_PARAM_NAME], ['brand', 'gtin'])) {
                $method = $header[static::FIELD_PARAM_GETTER] ?? static::PARAM_PRODUCT_GETTER_PREFIX . \Includes\Utils\Converter::convertToUpperCamelCase($header[static::FIELD_PARAM_NAME]);
