...
namespace XC\ProductTags\View\FormModel\Type;
...
class TagsLoader implements ChoiceLoaderInterface
{
    ...
    {
        /** @var \XC\ProductTags\Model\Tag $tags */
        $tags = \XLite\Core\Database::getRepo('XC\ProductTags\Model\Tag')->findAllTags();
    ...
    {
        return (string) ($this->labels[$value] ?? $value);
    }
}
