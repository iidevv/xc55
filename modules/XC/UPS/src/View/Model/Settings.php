...
class Settings extends \XLite\View\Model\AShippingSettings
{
    ...
    protected function getFormFieldByOption(\XLite\Model\Config $option)
    {
        ...
        switch ($option->getName()) {
            case 'dimensions':
                $dimensionUnit = \XC\UPS\Model\Shipping\Processor\UPS::getDimUnit();
            ...
            case 'currency_code':
                $cell[\XLite\View\FormField\Input\Text::PARAM_ATTRIBUTES] = ['readonly' => 'readonly'];
                break;
        }
    ...
    protected function getEditableOptions()
    {
        ...
        $unEditableOptions = ['cod_status', 'currency_code'];
