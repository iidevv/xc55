...
namespace XC\News\Logic\Sitemap\Step;
 ...
 */
class News extends \CDev\XMLSitemap\Logic\Sitemap\Step\ASitemapStep
{
    // {{{ Data
    ...
    {
        return Database::getRepo('XC\News\Model\NewsMessage');
    }
    ...
    protected function processItem($item)
    {
        ...
        if ($id) {
            if (isset($item['cleanURL']) && static::isSitemapCleanUrlConditionApplicable()) {
                ...
                $_url = Converter::buildURL('news_message', '', ['id' => $id], \XLite::getCustomerScript(), true);
            }
