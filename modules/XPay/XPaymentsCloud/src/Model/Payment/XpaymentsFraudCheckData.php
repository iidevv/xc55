 ...
 *
 * @ORM\Entity
 * @ORM\Table  (name="xpayments_fraud_check_data")
 */
class XpaymentsFraudCheckData extends \XLite\Model\AEntity
{
     ...
     * @var Transaction
     *
     * @ORM\ManyToOne (targetEntity="XLite\Model\Payment\Transaction", inversedBy="xp_cloud_payment_fraud_check_data", fetch="LAZY", cascade={"merge","detach","persist"})
