 ...
 * @Extender\Mixin
 */
abstract class Transaction extends \XLite\Model\Payment\Transaction implements \XLite\Base\IDecorator
{
    /**
     ...
     * @var FraudCheckData
     *
     * @ORM\OneToMany (targetEntity="\XPay\XPaymentsCloud\Model\Payment\XpaymentsFraudCheckData", mappedBy="transaction", cascade={"all"})
     */
