...
/**
 * OrderHistoryEventsData repository
 *
 * @Extender\Mixin
 */
abstract class OrderHistoryEventsData extends \XLite\Model\Repo\OrderHistoryEventsData implements \XLite\Base\IDecorator
{
    /**
    ...
    protected function getClearCCDataQueryBuilder()
    {
        return $this->createPureQueryBuilder($this->getDefaultAlias())
            ...
            ->setParameter('card_number', 'Card number')
            ->setParameter('exp_date', 'Expiration date');
    }
