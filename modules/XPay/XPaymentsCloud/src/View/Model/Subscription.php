...
class Subscription extends \XLite\View\Model\AModel
{
    ...
    /**
     * This object will be used if actual one is not passed
     *
     * @return \XPay\XPaymentsCloud\Model\Subscription\Subscription
     */
    protected function getDefaultModelObject()
    {
        $repo = \XLite\Core\Database::getRepo('XPay\XPaymentsCloud\Model\Subscription\Subscription');

        $model = $this->getModelId()
            ? $repo->find($this->getModelId())
            : null;

        return $model ?: new \XPay\XPaymentsCloud\Model\Subscription\Subscription;
    }
    ...
    {
        return '\XPay\XPaymentsCloud\View\Form\Model\Subscription';
    }
