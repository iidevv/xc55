...
namespace XPay\XPaymentsCloud\View\ItemsList\Model;

use XPay\XPaymentsCloud\Main as XPaymentsHelper;
use XLite\Model\WidgetParam\TypeString;
use XPay\XPaymentsCloud\Model\Subscription\Subscription as SubscriptionModel;
use XPay\XPaymentsCloud\Model\Repo\Subscription\Subscription as SubscriptionRepo;
...
class Subscription extends \XLite\View\ItemsList\Model\Table
{
    ...
    protected function defineColumns()
    {
        return [
            ...
            'status'           => [
                ...
                static::COLUMN_CLASS   => 'XPay\XPaymentsCloud\View\FormField\Inline\Select\SubscriptionStatus',
    ...
    {
        return $subscription->getActualDate() < \XPay\XPaymentsCloud\Core\Converter::now();
    }
    ...
    {
        return \XLite\Core\Database::getRepo('\XPay\XPaymentsCloud\Model\Subscription\Subscription')
