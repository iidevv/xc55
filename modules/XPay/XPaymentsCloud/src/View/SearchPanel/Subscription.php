...
namespace XPay\XPaymentsCloud\View\SearchPanel;

use \XPay\XPaymentsCloud\View\FormField\Select\SubscriptionStatus as FormFieldSubscriptionStatus;
...
class Subscription extends \XLite\View\SearchPanel\ASearchPanel
{
    ...
    {
        return 'XPay\XPaymentsCloud\View\Form\Search\Subscription';
    }
    ...
    protected function defineConditions()
    {
        return parent::defineConditions() + [
                ...
                'status'      => [
                    static::CONDITION_CLASS                                    => 'XPay\XPaymentsCloud\View\FormField\Select\SubscriptionStatus',
