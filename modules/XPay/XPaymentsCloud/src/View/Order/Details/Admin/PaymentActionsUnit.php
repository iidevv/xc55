...
namespace XPay\XPaymentsCloud\View\Order\Details\Admin;
 ...
 * @Extender\Mixin
 */
abstract class PaymentActionsUnit extends \XLite\View\Order\Details\Admin\PaymentActionsUnit implements \XLite\Base\IDecorator
{
    /**
    ...
    protected function getButtonWidgetClass(){
        ...
        if ($this->getParam(self::PARAM_TRANSACTION)->isXpayments()) {
            ...
            if (
                ...
                $class = 'XPay\XPaymentsCloud\View\FormField\Input\CaptureMultiple';
            }
