 ...
 */
class YourOrdersParcels extends YourOrders
{
    /**
     * Get your orders parcels url, text and is count flag
     *
     * @return array
     */
    protected function getBlockLinks(): array
    {
        return array_merge(
            ...
            [
                [
                    'url' => $this->buildURL('parcels'),
                    'text' => static::t('SkinActYourAccountPage parcels'),
                    'is_count' => false,
                    'position' => 4
                ]
            ]
