...
namespace Qualiteam\SkinActNewCheckout\View\Checkout;
 ...
 * @Extender\Mixin
 */
abstract class PaymentMethodsList extends \XLite\View\Checkout\PaymentMethodsList
{
    ...
    protected function showCheckoutTemplate(\XLite\Model\Payment\Method $method)
    {
        return true;
        //return !($method->getServiceName() === 'XPaymentsCloud')
        //     || $this->isPaymentSelected($method);
    }
}
