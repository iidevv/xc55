...
class SelectAddress implements ResolverInterface
{
    /**
     * @var Mapper\Cart
     */
    ...
    public function __invoke($val, $args, $context, ResolveInfo $info)
    {
        ...
        if (!$this->cartService->validateAddressType($args['type'])) {
            throw new \Exception("Unknown address type");
        }

        $this->cartService->selectCartAddress($cart, $args['address_id'], $args['type']);
