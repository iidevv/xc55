 ...
 */
class ColorSwatches implements ResolverInterface
{

    /**
     * @var Mapper\ColorSwatches
     */
    protected $mapper;
     ...
     */
    public function __construct(Mapper\ColorSwatches $mapper)
    {
        $this->mapper = $mapper;
    }
    ...
    {
        return $this->mapper->mapColorSwatches($val->productModel);
    }
}
