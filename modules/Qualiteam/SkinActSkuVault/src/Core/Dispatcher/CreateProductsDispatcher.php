...
use Qualiteam\SkinActSkuVault\Core\Factory\Commands\PushProductsCommandFactory;
...
class CreateProductsDispatcher
{
    ...
    {
        $productsIds = Database::getRepo(Product::class)->findProductIdsToCreateInSkuvault();

        /** @var PushProductsCommandFactory $commandFactory */
        $commandFactory = Container::getContainer() ? Container::getContainer()->get('Qualiteam\SkinActSkuVault\Core\Factory\Commands\PushProductsCommandFactory') : null;
