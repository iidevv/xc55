...
/**
 * @ListChild(list="chechout.shipping.selected.sub.payment.shipping.methods.after", zone="customer", weight=100)
 */
class ShippingMethodVideo extends \XLite\View\AView
{
    use AftershipTrait;
    ...
    {
        return $this->getModulePath() . '/checkout/steps/shipping/parts/shipping.video.twig';
    }
    ...
    protected function isVisible(): bool
    {
        return parent::isVisible()
            && Config::getInstance()->General->smsv_youtube_link;
    }
    ...
    public function getCSSFiles(): array
    {
        ...
        $list[] = $this->getModulePath() . '/checkout/steps/shipping/parts/shipping_video.less';
