...
class ShippingAddress
{
    ...
    {
        return $this->address && $this->address->getState() ? $this->address->getState()->getState() : '';
    }
     ...
     * @return string
     */
    public function getShippingAddressProvinceCode(): string
    {
        return $this->address && $this->address->getState() && $this->address->getState()->getCode() ? $this->address->getState()->getCode() : '';
    }
