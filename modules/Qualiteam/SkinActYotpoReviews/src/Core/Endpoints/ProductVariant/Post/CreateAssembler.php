...
class CreateAssembler
{
    protected string $path = '';

    /**
     * @param \Qualiteam\SkinActYotpoReviews\Core\Endpoints\ProductVariant\Post\CreateConstructor $createConstructor
     * @param \Qualiteam\SkinActYotpoReviews\Core\Endpoints\Assembler                             $assembler
     */
    public function __construct(
        private CreateConstructor $createConstructor,
