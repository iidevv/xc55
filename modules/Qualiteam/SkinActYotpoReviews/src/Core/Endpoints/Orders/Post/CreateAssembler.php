...
class CreateAssembler implements AssemblerInterface
{
    ...
    /**
     * @param \Qualiteam\SkinActYotpoReviews\Core\Endpoints\Orders\Post\CreateConstructor $constructorCreate
    ...
    public function setOrder(?Order $product)
    {
        $this->constructorCreate->prepareOrder($product);
    }
