    ...
    public function sendRequest(string $method, string $uri = '', array $options = []): ?array
    {
        try {
            ...
            if (!in_array($responseStatusCode, $this->successHttpCodes)) {
                ...
                $this->getLogger('yotpo.reviews.logger')->error('API error. Expected HTTP code "' . $codesString . '", received "' . $responseStatusCode . '"');
            ...
            $this->getLogger('yotpo.reviews.logger')->error($e);
