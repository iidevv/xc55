...
class XpcPopup extends \XLite\Controller\Customer\ACustomer
{
    ...
    {
        return (
            Iframe::IFRAME_DO_NOTHING != $this->getType()
    ...
    {
        return XPaymentsClient::getInstance()->isUnacceptedTemplateError($this->getMessage());
    }
    ...
    {
        return \XLite\Core\Config::getInstance()->Qualiteam->SkinActXPaymentsConnector->xpc_xpayments_url . 'admin.php';
    }
    ...
    protected function getNonXpcPaymentMethodId()
    {
        ...
        foreach ($methods as $method) {
            ...
            if ($method->getClass() != AXPayments::METHOD_XPAYMENTS) {
        ...
        if (!$methodId) {
            $methodId = $this->getNextPaymentMethodId();
        }
    ...
    public function getButtonAction()
    {
        ...
        switch ($this->getType()) {
            ...
            case Iframe::IFRAME_CHANGE_METHOD:
