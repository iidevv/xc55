 ...
 *
 * @ORM\Entity
 * @ORM\Table  (name="xpc_payment_fraud_check_data")
 */
class FraudCheckData extends \XLite\Model\AEntity
{
     ...
     *
     * @ORM\ManyToOne (targetEntity="XLite\Model\Payment\Transaction", inversedBy="xpc_payment_fraud_check_data", fetch="LAZY", cascade={"merge","detach","persist"})
