...
class ApiRequest extends \XLite\Base
{
    ...
    public static function writeLogError($error, $logData = null)
    {
        ...
        static::getStaticLogger('Qualiteam-SkinActXPaymentsConnector')->error($logData);
    }
    ...
    public static function throwError($error, $logData = null)
    {
        ...
        throw new XpcResponseException($error);
    }
    ...
    public function send($target, $action, array $data = array(), $apiVersion = false)
    {
        ...
        } catch (XpcResponseException $exception) {
    ...
    protected function checkError($response)
    {
        ...
        if ($code || $message) {
            ...
            $error = XPaymentsClient::getInstance()
    ...
    protected function decryptXmlPostprocess($data)
    {
        ...
        if ($crcType !== 'MD5') {
            self::throwError('CRC hash is not MD5');
        }
    ...
    public function __construct()
    {
        ...
        $this->response = new \Qualiteam\SkinActXPaymentsConnector\Transport\Response;
    }
}
