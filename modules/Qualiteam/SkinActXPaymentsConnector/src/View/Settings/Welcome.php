 ...
 */
class Welcome extends ASettings
{
    /** 
    ...
    {
        $id = Request::getInstance()->method_id;

        $method = $id
            ? Database::getRepo('XLite\Model\Payment\Method')->find($id)
            : null;
    ...
    public function getAddPaymentConfLink()
    {
        ...
        return Config::getInstance()->Qualiteam->SkinActXPaymentsConnector->xpc_xpayments_url . 'admin.php?target=payment_conf&module_class=' . $xpModuleClass;
    }
