...
class SavedCards extends Table
{
    ...
    protected function defineColumns()
    {
        return array(
            'default' => array(
                ...
                static::COLUMN_TEMPLATE => 'modules/Qualiteam/SkinActXPaymentsConnector/account/default_radio.twig',
                static::COLUMN_ORDERBY  => 100,
            ),
            'order' => array(
                static::COLUMN_NAME     => Translation::lbl('Order'),
                static::COLUMN_NO_WRAP  => true,
                static::COLUMN_LINK     => 'order',
                static::COLUMN_ORDERBY  => 200,
            ),
            'card' => array(
                static::COLUMN_NAME     => Translation::lbl('Credit card'),
                static::COLUMN_TEMPLATE => 'modules/Qualiteam/SkinActXPaymentsConnector/account/card.twig',
                static::COLUMN_NO_WRAP  => true,
                static::COLUMN_ORDERBY  => 300,
            ),
            'address' => array(
                static::COLUMN_NAME     => Translation::lbl('Billing address'),
                static::COLUMN_NO_WRAP  => true,
                static::COLUMN_MAIN     => true,
                static::COLUMN_TEMPLATE => 'modules/Qualiteam/SkinActXPaymentsConnector/account/card_address.twig',
    ...
    */
    ...
    {
        return \Qualiteam\SkinActXPaymentsConnector\View\StickyPanel\SavedCards::class;
    }
