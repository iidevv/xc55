 ...
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_CHAR = 'char';

/**
 * SQL data type - VARCHAR
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_VARCHAR = 'varchar';

/**
 * SQL data type - BOOLEAN
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_BOOLEAN = 'boolean';

/**
 * SQL data type - TEXT
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_TEXT = 'text';

/**
 * SQL data type - INTEGER
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_INTEGER = 'integer';

/**
 * SQL data type - FLOAT
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_DECIMAL = 'decimal';

/**
 * SQL data type - FLOAT
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_FLOAT = 'float';

/**
 * SQL data type - SERIAL (AUTO_INCREMENT for you MySQL users)
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_SERIAL = 'serial';

/**
 * SQL data type - DATE
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_DATE = 'date';

/**
 * SQL data type - TIME
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_TIME = 'time';

/**
 * SQL data type - DATETIME
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_DATETIME = 'datetime';

/**
 * SQL data type - TIMESTAMP (preferably auto-updating)
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_TIMESTAMP = 'timestamp';

/**
 *
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_TIMESTAMP_ON_INSERT_OR_UPDATE = 'timestamp-on-update-or-insert';

/**
 *
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_TIMESTAMP_ON_UPDATE = 'timestamp-on-update';

/**
 *
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_TIMESTAMP_ON_INSERT = 'timestamp-on-insert';

/**
 * This is the prefix for the base SQL tables
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_PREFIX = 'quickbooks_';

/**
 * This is the prefix for the SQL mirror tables
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_PREFIX_SQL = 'qb_';

/**
 * This is the prefix used for any extra SQL tables needed by the integrators
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_PREFIX_INTEGRATOR = 'qb_';

/**
 * Default table name for SQL log table
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_LOGTABLE = 'log';

/**
 * Default table name for SQL queue table
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_QUEUETABLE = 'queue';

/**
 * Default table name for SQL recurring events table
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_RECURTABLE = 'recur';

/**
 * Default table name for SQL ticket table
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_TICKETTABLE = 'ticket';

/**
 * Default table name for SQL user table
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_USERTABLE = 'user';

/**
 * Default table name for SQL ident table
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_IDENTTABLE = 'ident';

/**
 * Default table name for SQL config table
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_CONFIGTABLE = 'config';

/**
 * Default table name for SQL notification table
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_NOTIFYTABLE = 'notify';

/**
 * Default table name for SQL connection table
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_CONNECTIONTABLE = 'connection';

/**
 * Default table name for OAuth stuff
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_OAUTHV1TABLE = 'oauthv1';

/**
 * Default table name for OAuth stuff
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_OAUTHV2TABLE = 'oauthv2';
 ...
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_FIELD_ID = 'qbsql_id';

/**
 *
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_FIELD_USERNAME_ID = 'qbsql_username_id';

/**
 *
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_FIELD_EXTERNAL_ID = 'qbsql_external_id';
 ...
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_FIELD_DISCOVER = 'qbsql_discov_datetime';
 ...
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_FIELD_RESYNC = 'qbsql_resync_datetime';
 ...
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_FIELD_MODIFY = 'qbsql_modify_timestamp';
 ...
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_FIELD_HASH = 'qbsql_last_hash';
 ...
 *
 */
const QUICKBOOKS_DRIVER_SQL_FIELD_QBXML = 'qbsql_last_qbxml';

/**
 *
 */
const QUICKBOOKS_DRIVER_SQL_FIELD_AUDIT_AMOUNT = 'qbsql_audit_amount';

/**
 *
 */
const QUICKBOOKS_DRIVER_SQL_FIELD_AUDIT_MODIFIED = 'qbsql_audit_modified';
 ...
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_FIELD_TO_SYNC = 'qbsql_to_sync';
 ...
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_FIELD_TO_VOID = 'qbsql_to_void';
 ...
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_FIELD_TO_DELETE = 'qbsql_to_delete';
 ...
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_FIELD_TO_SKIP = 'qbsql_to_skip';
 ...
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_FIELD_FLAG_SKIPPED = 'qbsql_flag_skipped';

/**
 *
 *
 */
const QUICKBOOKS_DRIVER_SQL_FIELD_FLAG_DELETED = 'qbsql_flag_deleted';

/**
 *
 */
const QUICKBOOKS_DRIVER_SQL_FIELD_FLAG_VOIDED = 'qbsql_flag_voided';
 ...
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_FIELD_ERROR_NUMBER = 'qbsql_last_errnum';
 ...
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_FIELD_ERROR_MESSAGE = 'qbsql_last_errmsg';
 ...
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_FIELD_ENQUEUE_TIME = 'qbsql_enqueue_datetime';
 ...
 * @var string
 */
const QUICKBOOKS_DRIVER_SQL_FIELD_DEQUEUE_TIME = 'qbsql_dequeue_datetime';

/*
if (!defined('QUICKBOOKS_DRIVER_SQL_PREFIX'))
{
	const QUICKBOOKS_DRIVER_SQL_PREFIX', 'qb_');
}
*/

const QUICKBOOKS_DRIVER_SQL_SALT = '@ndP3pp@';
