...
class QuickbooksSyncCustomers extends QuickbooksSyncData
{
    ...
    {
        return parent::getItemsListClass() ?: 'Qualiteam\SkinActQuickbooks\View\ItemsList\QuickbooksSyncCustomers';
    }
