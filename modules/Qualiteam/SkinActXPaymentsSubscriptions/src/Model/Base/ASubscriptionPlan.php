...
namespace Qualiteam\SkinActXPaymentsSubscriptions\Model\Base;
 ...
 */
abstract class ASubscriptionPlan extends AEntity
{
    /**
     * Plan types
     */
    ...
    /**
     * Subscription plan type (each or every)
     *
     * @var string
     *
     ...
     * @return string
     */
    protected static function getDayOfWeek($dayIndex)
    {
        $dayOfWeek = '';

        if (array_key_exists($dayIndex, static::$daysOfWeek)) {
            $dayOfWeek = static::$daysOfWeek[$dayIndex];
        }
     ...
     * @return string
     */
    public function getPlanDescription($type = self::DESCRIPTION_LONG)
    {
     ...
     * @return string
     */
    public function getTotalPaymentsDescription()
    {
    ...
    {
        return $this instanceof Subscription;
    }
     ...
     * @return bool
     */
    protected function isPlan()
    {
        return $this instanceof SubscriptionPlan;
    }
    ...
    {
        return $this->isSubscription() ? $this->getSuccessTries() : 1;
    }
    ...
    protected function getNextEachWeek($checkDate)
    {
        ...
        return Converter::getStrtotime('next ' . static::getDayOfWeek($dayIndex - 1), $checkDate);
    }
    ...
    {
        return $this->getShortDescriptionEvery();
    }
