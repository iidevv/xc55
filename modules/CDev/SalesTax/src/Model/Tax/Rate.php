...
namespace CDev\SalesTax\Model\Tax;
 ...
 *
 * @ORM\Entity
 * @ORM\Table (name="sales_tax_rates")
 */
class Rate extends \XLite\Model\AEntity
{
     ...
     * Taxable bases
     */
    public const TAXBASE_SUBTOTAL                     = 'ST';
    public const TAXBASE_DISCOUNTED_SUBTOTAL          = 'DST';
    public const TAXBASE_SUBTOTAL_SHIPPING            = 'ST+SH';
    public const TAXBASE_DISCOUNTED_SUBTOTAL_SHIPPING = 'DST+SH';
    public const TAXBASE_SHIPPING                     = 'SH';
    public const TAXBASE_PERSONAL                     = 'P';
     ...
     *
     * @ORM\ManyToOne  (targetEntity="CDev\SalesTax\Model\Tax", inversedBy="rates")
     ...
     * @ORM\JoinColumn (name="tax_class_id", referencedColumnName="id", onDelete="CASCADE")
     */
    protected $taxClass;
     ...
     * Set tax
     *
     * @param \CDev\SalesTax\Model\Tax $tax
     * @return Rate
     */
    public function setTax(\CDev\SalesTax\Model\Tax $tax = null)
    {
        $this->tax = $tax;
        return $this;
    }
