...
class Menu extends \XLite\View\ItemsList\Model\Table
{
    ...
    protected function defineColumns()
    {
        return [
            ...
            'link'       => [
                ...
                static::COLUMN_CLASS     => 'CDev\SimpleCMS\View\FormField\Inline\Select\Select2\Pages',
            ...
            'visibleFor' => [
                ...
                static::COLUMN_CLASS   => 'CDev\SimpleCMS\View\FormField\VisibleFor',
    ...
    protected function getMenu()
    {
        return \XLite\Core\Request::getInstance()->id
            ? \XLite\Core\Database::getRepo('CDev\SimpleCMS\Model\Menu')
                ->find((int) \XLite\Core\Request::getInstance()->id)
            : \XLite\Core\Database::getRepo('CDev\SimpleCMS\Model\Menu')->getRootMenu();
    }
    ...
    protected function buildEntityURL(\XLite\Model\AEntity $entity, array $column)
    {
        ...
        return $column[static::COLUMN_CODE] === 'submenus'
            ? $link
    ...
    protected function createEntity()
    {
        ...
        if (\XLite\Core\Request::getInstance()->id) {
            $parent = \XLite\Core\Database::getRepo('CDev\SimpleCMS\Model\Menu')
                ->find((int) \XLite\Core\Request::getInstance()->id);
        }

        if (!$parent) {
            $parent = \XLite\Core\Database::getRepo('CDev\SimpleCMS\Model\Menu')->getRootMenu();
        }
    ...
    protected function getSearchCondition()
    {
        ...
        $result->{\CDev\SimpleCMS\Model\Repo\Menu::SEARCH_PARENT} = \XLite\Core\Request::getInstance()->id
            ? (int) \XLite\Core\Request::getInstance()->id
            : \XLite\Core\Database::getRepo('CDev\SimpleCMS\Model\Menu')->getRootMenuId();
    ...
    {
        return 'CDev\SimpleCMS\View\StickyPanel\ItemsList\Menu';
    }
    ...
    protected function getCommonParams()
    {
        ...
        $this->commonParams['page'] = $this->getType();
    ...
    {
        return parent::getSessionCell() . $this->getType();
    }
    ...
    {
        return str_replace('menus_', '', $this->getPage());
    }
}
