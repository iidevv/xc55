...
namespace CDev\XMLSitemap\Logic\Sitemap;
...
class Generator extends \XLite\Base implements \SeekableIterator, \Countable
{
    ...
    protected function initialize()
    {
        if (!FileManager::isExists(LC_DIR_DATA)) {
            ...
            if (!FileManager::isExists(LC_DIR_DATA)) {
                ...
                $this->getLogger('CDev-XMLSitemap')->error($message);
    ...
    {
        return [
            'CDev\XMLSitemap\Logic\Sitemap\Step\Welcome',
            'CDev\XMLSitemap\Logic\Sitemap\Step\Categories',
            'CDev\XMLSitemap\Logic\Sitemap\Step\Products',
        ];
    }
