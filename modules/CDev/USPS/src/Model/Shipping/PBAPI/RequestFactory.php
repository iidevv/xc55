...
use CDev\USPS\Model\Shipping\PBAPI\Request\CreateShipment;
use CDev\USPS\Model\Shipping\PBAPI\Request\DeleteShipment;
use CDev\USPS\Model\Shipping\PBAPI\Request\MerchantInfo;
use CDev\USPS\Model\Shipping\PBAPI\Request\OAuthToken;
use CDev\USPS\Model\Shipping\PBAPI\Request\Rates;
use CDev\USPS\Model\Shipping\PBAPI\Request\RequestException;
use CDev\USPS\Model\Shipping\PBAPI\Request\Tracking;
use CDev\USPS\Model\Shipping\PBAPI\TokenStorage\FactoryException;
use CDev\USPS\Model\Shipping\PBAPI\TokenStorage\TmpVar;
use CDev\USPS\Model\Shipping\PBAPI\TokenStorage\TokenStorageException;
...
class RequestFactory
{
    ...
    {
        $this->mode          = $mode;
        $this->tokenStorage  = $tokenStorage ?? new TmpVar();
    }
