...
namespace CDev\USPS\View\ItemsList\Model;
...
class Shipment extends \XLite\View\ItemsList\Model\Table
{
    ...
    {
        return [
            \CDev\USPS\Model\Repo\Shipment::SEARCH_ORDER_ID => static::PARAM_ORDER_ID,
        ];
    }
    ...
    {
        return 'CDev\USPS\Model\Shipment';
    }
    ...
    protected function postprocessSearchCase(\XLite\Core\CommonCell $searchCase)
    {
        ...
        $searchCase->{\CDev\USPS\Model\Repo\Shipment::SEARCH_ORDER_ID} = $this->getOrderId();
    ...
    /**
     * @param \CDev\USPS\Model\Shipment $shipment
     *
     * @return array
     */
