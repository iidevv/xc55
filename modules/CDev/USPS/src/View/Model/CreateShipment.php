...
use CDev\USPS\View\FormField\Select\SpecialService;
...
{
    public const SECTION_SHIPMENT_OPTIONS = 'shipmentOptions';
    ...
    protected function saveFormData($data)
    {
        ...
        $driver->save($this->getFormName(), $data ?? []);
    }
    ...
    protected function defineSchemaDefault()
    {
        ...
        return [
            ...
            'specialServices' => [
                self::SCHEMA_CLASS => 'CDev\USPS\View\FormField\Select\SpecialService',
            ...
            'labelFormat'       => [
                self::SCHEMA_CLASS => 'CDev\USPS\View\FormField\Select\LabelFormat',
                self::SCHEMA_LABEL => static::t('Label format'),
            ],
            'labelSize'       => [
                self::SCHEMA_CLASS => 'CDev\USPS\View\FormField\Select\LabelSize',
    ...
    protected function defineSchemaShipmentOptions()
    {
        return [
            ...
            'nonDeliveryOption'            => [
                self::SCHEMA_CLASS => 'CDev\USPS\View\FormField\Select\NonDeliveryOption',
    ...
    {
        return 'CDev\USPS\View\Form\CreateShipment';
    }
