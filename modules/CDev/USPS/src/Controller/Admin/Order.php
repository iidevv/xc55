...
use CDev\USPS\View\Model\CreateShipment;
use XLite\Core\Auth;
...
class Order extends \XLite\Controller\Admin\Order
{
     ...
     * Page key
     */
    public const PAGE_USPS_PB_SHIPMENTS = 'usps_pb_shipments';
    ...
    protected function doActionUspsUpdateTracking()
    {
        ...
        /** @var \CDev\USPS\Model\Shipment $shipment */
        $shipment = \XLite\Core\Database::getRepo('CDev\USPS\Model\Shipment')->find($shipmentId);
