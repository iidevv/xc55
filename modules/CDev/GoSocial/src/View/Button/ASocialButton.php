...
/**
 * Class ASocialButton
 * @package CDev\GoSocial\View\Button
 */
abstract class ASocialButton extends \XLite\View\AView
{
    public const BUTTON_CLASS_FACEBOOK = 'facebook';
    public const BUTTON_CLASS_TWITTER = 'twitter';
    public const BUTTON_CLASS_PINTEREST = 'pinterest';
    ...
    public function getJSFiles()
    {
        ...
        $list[] = 'modules/CDev/GoSocial/likely.load.js';
     ...
     * @return string
     */
    abstract public function getButtonType();
