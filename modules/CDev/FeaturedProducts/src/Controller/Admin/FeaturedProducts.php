...
namespace CDev\FeaturedProducts\Controller\Admin;
...
class FeaturedProducts extends \XLite\Controller\Admin\AAdmin
{
    ...
    {
        return \XLite\Core\Request::getInstance()->id && $this->isVisible()
    ...
    protected function getLocation()
    {
        if (!$this->isVisible()) {
            ...
            return \XLite\Core\Request::getInstance()->id
                ...
                : (Auth::getInstance()->isPermissionAllowed(Permission::ROOT_ACCESS)
                    ? (\XLite\Core\Request::getInstance()->page == 'front_page' ? static::t('Front page') : static::t('Products'))
                    : static::t('Featured products'));
        }
    }
            ...
            if ($products) {
                foreach ($products as $product) {
                    if (in_array($product->getProductId(), $existingLinksIds)) {
                        ...
                        $fp = new \CDev\FeaturedProducts\Model\FeaturedProduct();
