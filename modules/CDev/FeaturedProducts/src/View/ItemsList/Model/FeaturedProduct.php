...
{
    public const PARAM_CATEGORY_ID = 'id';
    ...
    {
        return 'CDev\FeaturedProducts\View\StickyPanel\ItemsList\FeaturedProduct';
    }
    ...
    {
        return [
            \CDev\FeaturedProducts\Model\Repo\FeaturedProduct::SEARCH_CATEGORY_ID => static::PARAM_CATEGORY_ID,
        ];
    }
