...
use CDev\Egoods\Core\AmazonS3;

/**
 * @ORM\MappedSuperclass
 * @Extender\Mixin
 */
abstract class Storage extends \CDev\FileAttachments\Model\Product\Attachment\Storage
{
    /**
     * Private suffix length
     */
    public const PRIVATE_SUFFIX_LENGTH = 33;
     ...
     * @return string
     */
    public function getDownloadURL(\CDev\Egoods\Model\OrderItem\PrivateAttachment $attachment)
    {
