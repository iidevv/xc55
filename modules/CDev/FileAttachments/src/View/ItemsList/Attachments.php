...
namespace CDev\FileAttachments\View\ItemsList;
...
class Attachments extends \XLite\View\ItemsList\Model\Table
{
    ...
    protected function defineColumns()
    {
        return [
            'title'       => [
                ...
                static::COLUMN_CLASS   => 'CDev\FileAttachments\View\FormField\Inline\Input\Text\File',
                static::COLUMN_PARAMS => [
                    \XLite\View\FormField\Input\Base\StringInput::PARAM_MAX_LENGTH => \XLite\Core\Database::getRepo('CDev\FileAttachments\Model\Product\AttachmentTranslation')->getFieldInfo('title', 'length'),
                ],
                static::COLUMN_ORDERBY => 100,
            ],
            'description' => [
                static::COLUMN_NAME    => \XLite\Core\Translation::lbl('Description'),
                static::COLUMN_CLASS   => 'CDev\FileAttachments\View\FormField\Inline\Textarea\Description',
                static::COLUMN_ORDERBY => 200,
                static::COLUMN_MAIN    => true,
            ],
            'access'      => [
                static::COLUMN_NAME    => \XLite\Core\Translation::lbl('Membership'),
                static::COLUMN_CLASS   => 'CDev\FileAttachments\View\FormField\Inline\Select\AttributeMembership',
     ...
     * @return string
     */
    protected function getFileLink(\CDev\FileAttachments\Model\Product\Attachment $attachment)
    {
    ...
    protected function postprocessSearchCase(\XLite\Core\CommonCell $searchCase)
    {
        ...
        $searchCase->{\CDev\FileAttachments\Model\Repo\Product\Attachment::P_PRODUCT} = $this->getProduct();
