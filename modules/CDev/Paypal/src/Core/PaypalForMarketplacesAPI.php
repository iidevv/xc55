...
use XLite\Logger;
use CDev\Paypal\Core\Api\Orders\Amount;
use CDev\Paypal\Core\Api\Orders\ApplicationContext;
use CDev\Paypal\Core\Api\Orders\Capture;
use CDev\Paypal\Core\Api\Orders\Order;
use CDev\Paypal\Core\Api\Orders\Payee;
use CDev\Paypal\Core\Api\Orders\PayOrderRequest;
use CDev\Paypal\Core\Api\Orders\PayOrderResponse;
use CDev\Paypal\Core\Api\Orders\PurchaseUnit;
use CDev\Paypal\Core\Api\Orders\RedirectUrls;
use CDev\Paypal\Core\Api\Orders\ShippingAddress;
use CDev\Paypal\Core\Api\Payments\Refund;
use CDev\Paypal\Core\Api\ReferencedPayouts\ReferencedPayoutsItem;
...
use CDev\Paypal\Core\Api\PartnerReferrals\Capability;
use CDev\Paypal\Core\Api\PartnerReferrals\IntegrationDetails;
use CDev\Paypal\Core\Api\PartnerReferrals\LegalConsent;
use CDev\Paypal\Core\Api\PartnerReferrals\MerchantIntegration;
use CDev\Paypal\Core\Api\PartnerReferrals\PartnerSpecificIdentifier;
use CDev\Paypal\Core\Api\PartnerReferrals\ReferralData;
use CDev\Paypal\Core\Api\PartnerReferrals\RestApiIntegration;
use CDev\Paypal\Core\Api\PartnerReferrals\RestThirdPartyDetails;
use CDev\Paypal\Core\Api\PartnerReferrals\User;
use CDev\Paypal\Core\Api\PartnerReferrals\WebExperiencePreference;
