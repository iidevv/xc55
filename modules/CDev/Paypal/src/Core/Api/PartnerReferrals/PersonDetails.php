 ...
 * @property \CDev\Paypal\Core\Api\PartnerReferrals\Name                       name
 * @property \CDev\Paypal\Core\Api\PartnerReferrals\PhoneDetails[]             phone_contacts
 * @property \PayPal\Api\Address                                                            home_address
 * @property \CDev\Paypal\Core\Api\PartnerReferrals\DateOfEvent                date_of_birth
 * @property string                                                                         nationality_country_code
 * @property \CDev\Paypal\Core\Api\PartnerReferrals\IdentityDocument[]         identity_documents
 * @property \CDev\Paypal\Core\Api\PartnerReferrals\AccountOwnerRelationship[] account_owner_relationships
 */
class PersonDetails extends PayPalModel
{
    ...
    /**
     * @return \CDev\Paypal\Core\Api\PartnerReferrals\Name
     */
    ...
    /**
     * @param \CDev\Paypal\Core\Api\PartnerReferrals\Name $name
     *
     * @return PersonDetails
     */
    ...
    /**
     * @return \CDev\Paypal\Core\Api\PartnerReferrals\PhoneDetails[]
     */
    ...
    /**
     * @param \CDev\Paypal\Core\Api\PartnerReferrals\PhoneDetails[] $phone_contacts
     *
     * @return PersonDetails
     */
    ...
    /**
     * @param \CDev\Paypal\Core\Api\PartnerReferrals\PhoneDetails $phone_contact
     *
     * @return PersonDetails
     */
    ...
    /**
     * @return \CDev\Paypal\Core\Api\PartnerReferrals\DateOfEvent
     */
    ...
    /**
     * @param \CDev\Paypal\Core\Api\PartnerReferrals\DateOfEvent $date_of_birth
     *
     * @return PersonDetails
     */
    ...
    /**
     * @return \CDev\Paypal\Core\Api\PartnerReferrals\IdentityDocument[]
     */
    ...
    /**
     * @param \CDev\Paypal\Core\Api\PartnerReferrals\IdentityDocument[] $identity_documents
     *
     * @return PersonDetails
     */
    ...
    /**
     * @param \CDev\Paypal\Core\Api\PartnerReferrals\IdentityDocument $identity_document
     *
     * @return PersonDetails
     */
    ...
    /**
     * @return \CDev\Paypal\Core\Api\PartnerReferrals\AccountOwnerRelationship[]
     */
    ...
    /**
     * @param \CDev\Paypal\Core\Api\PartnerReferrals\AccountOwnerRelationship[] $account_owner_relationships
     *
     * @return PersonDetails
     */
    ...
    /**
     * @param \CDev\Paypal\Core\Api\PartnerReferrals\AccountOwnerRelationship $account_owner_relationship
     *
     * @return PersonDetails
     */
