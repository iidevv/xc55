...
use CDev\Paypal\View\FormField\Input\BannerPagePosition;
...
class PaypalCredit extends \XLite\View\Model\AModel
{
    ...
    protected function getFormFieldsForSectionDefault()
    {
        ...
        if (\XLite::getController() instanceof \CDev\Paypal\Controller\Admin\PaypalCredit) {
            $this->schemaDefault = array_merge(
                $this->schemaDefault,
    ...
    protected function getPPCMFields()
    {
        return [
            ...
            'ppcm_product_page' => [
                self::SCHEMA_CLASS => 'CDev\Paypal\View\FormField\Input\BannerPagePosition',
                self::SCHEMA_LABEL => 'Banner on product pages',
                BannerPagePosition::PARAM_POSITION => BannerPagePosition::POSITION_PRODUCT_PAGE,
                self::SCHEMA_DEPENDENCY => [
                    self::DEPENDENCY_SHOW => [
                        'ppcm_enabled' => true,
                        'enabled' => true,
            ...
            'ppcm_cart_page' => [
                ...
                BannerPagePosition::PARAM_POSITION => BannerPagePosition::POSITION_CART_PAGE,
                self::SCHEMA_DEPENDENCY => [
                    self::DEPENDENCY_SHOW => [
                        'ppcm_enabled' => true,
                        'enabled' => true,
            ...
            'ppcm_checkout_page' => [
                ...
                BannerPagePosition::PARAM_POSITION => BannerPagePosition::POSITION_CHECKOUT,
                self::SCHEMA_DEPENDENCY => [
                    self::DEPENDENCY_SHOW => [
                        'ppcm_enabled' => true,
                        'enabled' => true,
            ...
            'banner_preview'   => [
                self::SCHEMA_CLASS    => 'CDev\Paypal\View\FormField\BannerPreview',
                self::SCHEMA_DEPENDENCY => [
                    self::DEPENDENCY_SHOW => [
                        'ppcm_enabled' => true,
                        'enabled' => true,
            ...
            'ppcm_banner_type'   => [
                self::SCHEMA_CLASS    => 'CDev\Paypal\View\FormField\Select\PPCMBannerType',
            ...
            'ppcm_text_logo_type'   => [
                self::SCHEMA_CLASS    => 'CDev\Paypal\View\FormField\Select\PPCMTextLogoType',
            ...
            'ppcm_text_logo_position'   => [
                self::SCHEMA_CLASS    => 'CDev\Paypal\View\FormField\Select\PPCMTextLogoPosition',
            ...
            'ppcm_text_size'   => [
                self::SCHEMA_CLASS    => 'CDev\Paypal\View\FormField\Select\PPCMTextSize',
            ...
            'ppcm_text_color'   => [
                self::SCHEMA_CLASS    => 'CDev\Paypal\View\FormField\Select\PPCMTextColor',
            ...
            'ppcm_flex_color_scheme'   => [
                self::SCHEMA_CLASS    => 'CDev\Paypal\View\FormField\Select\PPCMFlexColorScheme',
            ...
            'ppcm_flex_layout'   => [
                self::SCHEMA_CLASS    => 'CDev\Paypal\View\FormField\Select\PPCMFlexLayout',
    ...
    protected function getLegacyCreditFields()
    {
        return [
            ...
            'bannerOnHomePage' => [
                self::SCHEMA_CLASS    => 'CDev\Paypal\View\FormField\Select\BannerOnHomePage',
            ...
            'bannerOnCategoryPages' => [
                self::SCHEMA_CLASS    => 'CDev\Paypal\View\FormField\Select\BannerOnCategoryPages',
            ...
            'bannerOnProductDetailsPages' => [
                self::SCHEMA_CLASS    => 'CDev\Paypal\View\FormField\Select\BannerOnProductDetailsPages',
            ...
            'bannerOnCartPage' => [
                self::SCHEMA_CLASS    => 'CDev\Paypal\View\FormField\Select\BannerOnCartPage',
    ...
    {
        return 'CDev\Paypal\View\Form\PaypalCreditSettings';
    }
    ...
    protected function isExpressCheckoutEmailAPIType()
    {
        ...
        return $expressCheckout->getSetting('api_type') === 'email';
    }
