 ...
 */
class PaypalForMarketplaces extends \CDev\Paypal\View\Model\ASettings
{
    /**
    ...
    protected $schemaAccount = [
        ...
        'additional_email_sep' => [
            self::SCHEMA_CLASS    => 'CDev\Paypal\View\FormField\Separator\AdditionalAccount',
            self::SCHEMA_LABEL    => 'Additional PayPal Business Account',
            self::SCHEMA_REQUIRED => true,
        ],
        'additional_email'     => [
            self::SCHEMA_CLASS    => 'CDev\Paypal\View\FormField\Input\AdditionalAccount',
            self::SCHEMA_LABEL    => '',
    ...
    protected $schemaAdditional = [
        ...
        'disburse_funds' => [
            self::SCHEMA_CLASS    => 'CDev\Paypal\View\FormField\Select\DisburseFunds',
