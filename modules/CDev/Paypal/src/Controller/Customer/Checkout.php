...
class Checkout extends \XLite\Controller\Customer\Checkout
{
    ...
    protected function doActionStartExpressCheckout()
    {
        if (Paypal\Main::isExpressCheckoutEnabled() || Paypal\Main::isPaypalForMarketplacesEnabled()) {
            ...
            if (
                \XLite\Core\Request::getInstance()->method === Paypal\Main::PP_METHOD_PFM
    ...
    protected function doActionExpressCheckoutReturn()
    {
        ...
        $this->getLogger('CDev-Paypal')->debug('doExpressCheckoutReturn()', [
        ...
        if (isset($request->cancel)) {
            ...
            /** @var \CDev\Paypal\Model\Payment\Processor\ExpressCheckout|\CDev\Paypal\Model\Payment\Processor\ExpressCheckoutMerchantAPI $processor */
    ...
    {
        $isEC = (\XLite\Core\Session::getInstance()->ec_type == Paypal\Model\Payment\Processor\ExpressCheckout::EC_TYPE_SHORTCUT);
        ...
        /** @var \CDev\Paypal\Model\Order $cart */
        $cart = $this->getCart();
    ...
    protected function doActionCheckout()
    {
        ...
        if ($paymentMethods) {
            ...
            if (
                $processor instanceof \CDev\Paypal\Model\Payment\Processor\PayflowTransparentRedirect
