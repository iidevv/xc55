...
namespace CDev\Wholesale\View\ItemsList;
...
class WholesalePrices extends \XLite\View\ItemsList\Model\Table
{
    ...
    protected function defineColumns()
    {
        return [
            'quantityRangeBegin' => [
                ...
                static::COLUMN_CLASS   => 'CDev\Wholesale\View\FormField\QuantityRangeBegin',
                static::COLUMN_ORDERBY => 100,
            ],
            'membership'         => [
                static::COLUMN_NAME    => \XLite\Core\Translation::lbl('Membership'),
                static::COLUMN_CLASS   => 'CDev\Wholesale\View\FormField\Membership',
                static::COLUMN_ORDERBY => 200,
            ],
            'price'              => [
                static::COLUMN_CLASS   => '\CDev\Wholesale\View\FormField\Inline\Input\WholesalePriceOrPercent',
    ...
    /**
     * @param $entity \CDev\Wholesale\Model\WholesalePrice
     * @return string
     */
    ...
    {
        return 'CDev\Wholesale\Model\WholesalePrice';
    }
    ...
    protected function getData(\XLite\Core\CommonCell $cnd, $countOnly = false)
    {
        ...
        $cnd->{\CDev\Wholesale\Model\Repo\WholesalePrice::P_PRODUCT} = $this->getProduct();
        $cnd->{\CDev\Wholesale\Model\Repo\WholesalePrice::P_ORDER_BY} = [
            ['w.membership', 'ASC'],
    ...
    protected function prevalidateEntities()
    {
        if (parent::prevalidateEntities()) {
            ...
            /** @var \CDev\Wholesale\Model\Base\AWholesalePrice $entity */
            foreach ($this->getPageDataForUpdate() as $entity) {
                ...
                if (
                    array_filter($entities, static function ($tier) use ($entity) {
     ...
     *
     * @param \CDev\Wholesale\Model\Base\AWholesalePrice $entity
     *
     * @return \CDev\Wholesale\Model\Base\AWholesalePrice
     */
