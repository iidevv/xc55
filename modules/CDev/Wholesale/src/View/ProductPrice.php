...
class ProductPrice extends \XLite\View\Product\Details\Customer\Widget
{
    ...
    {
        return Database::getRepo('CDev\Wholesale\Model\WholesalePrice')->getWholesalePrices(
            $this->getProduct(),
    ...
    /**
     * @param \CDev\Wholesale\Model\Base\AWholesalePrice[] $wholesalePrices
     *
     * @return array
     */
    protected function prepareWholesalePrices($wholesalePrices)
    {
        ...
        foreach ($wholesalePrices as $wholesalePrice) {
            $tier = new \CDev\Wholesale\Model\DTO\WholesalePrice();
     ...
     * @param $minQty
     * @return \CDev\Wholesale\Model\DTO\WholesalePrice
     */
    protected function prepareZeroTier($firstWholesalePrice, $minQty)
    {
        $zeroTier = new \CDev\Wholesale\Model\DTO\WholesalePrice();
