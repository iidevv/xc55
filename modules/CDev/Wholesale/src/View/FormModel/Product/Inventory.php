...
class Inventory extends \XLite\View\FormModel\Product\Inventory
{
    ...
    protected function defineFields()
    {
        ...
        if (
            isset($minimumPurchaseQuantityData->membership_0)
        ...
        $price = \XLite\Core\Database::getRepo('CDev\Wholesale\Model\WholesalePrice')->getPrice(
            $product,
        ...
        foreach (\XLite\Core\Database::getRepo('XLite\Model\Membership')->findAll() as $membership) {
            ...
            if (
                isset($minimumPurchaseQuantityData->{$key})
