...
class Order extends \XLite\Controller\Admin\Order
{
    ...
    {
        return array_merge(parent::defineFreeFormIdActions(), ['check_coupon']);
    }
    ...
    protected function assembleDcouponDumpSurcharge()
    {
        return $this->assembleDefaultDumpSurcharge(
            ...
            \CDev\Coupons\Logic\Order\Modifier\Discount::MODIFIER_CODE,
            '\CDev\Coupons\Logic\Order\Modifier\Discount',
    ...
    protected function getRequiredSurcharges()
    {
        ...
        $couponsCount = \XLite\Core\Database::getRepo('CDev\Coupons\Model\Coupon')->search($cnd, true);
    ...
    protected static function getFieldHumanReadableNames()
    {
        return array_merge(
            ...
            [
                \CDev\Coupons\Logic\Order\Modifier\Discount::MODIFIER_CODE  => 'Coupon discount',
            ]
        );
    }
