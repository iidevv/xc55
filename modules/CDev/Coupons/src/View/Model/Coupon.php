...
namespace CDev\Coupons\View\Model;
...
{
    public const PARAM_MAX_UNSIGNED_INT_VALUE = 4294967295;
    ...
    protected $schemaDefault = [
        'code'             => [
            self::SCHEMA_CLASS    => 'CDev\Coupons\View\FormField\Code',
        ...
        'enabled'          => [
            self::SCHEMA_CLASS => 'CDev\Coupons\View\FormField\Enabled',
            self::SCHEMA_LABEL => 'Enabled',
        ],
        'type'             => [
            self::SCHEMA_CLASS    => 'CDev\Coupons\View\FormField\DiscountType',
        ...
        'dateRangeBegin'   => [
            self::SCHEMA_CLASS => 'CDev\Coupons\View\FormField\Date',
        ...
        'totalRangeBegin'  => [
            self::SCHEMA_CLASS            => 'CDev\Coupons\View\FormField\Total',
    ...
    protected function getDefaultModelObject()
    {
        $model = $this->getModelId()
            ? \XLite\Core\Database::getRepo('CDev\Coupons\Model\Coupon')->find($this->getModelId())
            : null;

        return $model ?: new \CDev\Coupons\Model\Coupon();
    }
    ...
    {
        return '\CDev\Coupons\View\Form\Coupon';
    }
    ...
    {
        $productClasses = $data['productClasses'] ?? null;
        ...
        /** @var \CDev\Coupons\Model\Coupon $entity */
        ...
        if ($isSpecificProducts === false && is_array($productClasses)) {
        ...
        if ($isSpecificProducts === false && is_array($categories)) {
        ...
        if ($isSpecificProducts === false) {
            /** @var \XLite\Model\AEntity $cp */
            foreach ($entity->getCouponProducts() as $cp) {
                \XLite\Core\Database::getRepo('CDev\Coupons\Model\CouponProduct')->delete($cp, false);
            }
