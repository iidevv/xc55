...
namespace CDev\Coupons\View\ItemsList;
...
class Coupons extends \XLite\View\ItemsList\Model\Table
{
    ...
    {
        return static::t('X coupon(s) has been created', ['count' => $count]);
    }
    ...
    {
        return static::t('X coupon(s) has been removed', ['count' => $count]);
    }
    ...
    {
        return 'CDev\Coupons\View\StickyPanel\Coupon\Admin\Coupons';
    }
    ...
    {
        return \XLite\Core\Database::getRepo('CDev\Coupons\Model\Coupon')->search($cnd, $countOnly);
    }
     ...
     * @return boolean
     */
    protected function isInfinityUsesLeft(\CDev\Coupons\Model\Coupon $coupon)
    {
     ...
     * @return integer
     */
    protected function getUsesLeft(\CDev\Coupons\Model\Coupon $coupon)
    {
     ...
     * @return float
     */
    protected function formatPercentDiscount(\CDev\Coupons\Model\Coupon $coupon)
    {
     ...
     * @return string
     */
    protected function preprocessUses($value, array $column, \CDev\Coupons\Model\Coupon $coupon)
    {
     ...
     * @return string
     */
    protected function preprocessDateRangeBegin($value, array $column, \CDev\Coupons\Model\Coupon $coupon)
    {
        return 0 >= $value
            ? '-'
     ...
     * @return string
     */
    protected function preprocessDateRangeEnd($value, array $column, \CDev\Coupons\Model\Coupon $coupon)
    {
        return 0 >= $value
            ? '-'
            : $this->formatDate($value);
    ...
    /**
     * Preprocess value for code column
     *
     * @param mixed                                   $value  Value
     * @param array                                   $column Column data
     * @param \CDev\Coupons\Model\Coupon $coupon Entity
     ...
     * @return string
     */
    protected function preprocessCode($value, array $column, \CDev\Coupons\Model\Coupon $coupon)
    {
        return htmlspecialchars($value);
    }

    /**
     * Preprocess value for comment column
     *
     * @param mixed                                   $value  Value
     * @param array                                   $column Column data
     * @param \CDev\Coupons\Model\Coupon $coupon Entity
     ...
     * @return string
     */
    protected function preprocessComment($value, array $column, \CDev\Coupons\Model\Coupon $coupon)
    {
        return htmlspecialchars($value);
    }
