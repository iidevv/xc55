 ...
 */
abstract class RecentlyViewed extends \CDev\ProductAdvisor\View\RecentlyViewed implements ThemeTweaker\View\LayoutBlockInterface
{
    ...
    protected function getDisplayMode()
    {
        if ($this->getDisplayGroup() === static::DISPLAY_GROUP_SIDEBAR) {
            return static::DISPLAY_MODE_TEXTS;
        } else {
