...
use CDev\MarketPrice\API\Endpoint\Product\DTO\Input as DecoratedInputDTO;
...
class InputTransformer extends \XLite\API\Endpoint\Product\Transformer\InputTransformer
{
    ...
    public function transform($object, string $to, array $context = []): Product
    {
        ...
        $model->setMarketPrice($object->market_price);
    ...
    public function initialize(string $inputClass, array $context = [])
    {
        ...
        $input->market_price = $product->getMarketPrice();
