 ...
 */
class Bestsellers extends \CDev\Bestsellers\View\ABestsellers
{
    /**
     * List names where the Bestsellers block is located
     */
    public const SIDEBAR_LIST   = 'sidebar.first';
    public const SIDEBAR_SINGLE = 'sidebar.single';
    public const CENTER_LIST    = 'center.bottom';
    ...
    protected function getTemplate()
    {
        ...
        if (
            ...
            && $this->getParam(static::PARAM_WIDGET_TYPE) === static::WIDGET_TYPE_SIDEBAR
        ) {
