 ...
 */
class SaleBlock extends \CDev\Sale\View\ASale
{
    use CacheableTrait;
    ...
    public function setWidgetParams(array $params)
    {
        ...
        if (isset($params['viewListName']) && $params['viewListName'] === 'center.bottom') {
    ...
    protected function postprocessSearchCase(\XLite\Core\CommonCell $searchCase)
    {
        ...
        if (\XLite::getController()->getTarget() === 'main') {
            $searchCase->{\XLite\Model\Repo\Product::P_CATEGORY_ID} = null;
    ...
    protected function getTemplate()
    {
        ...
        if (
            ...
            && $this->getWidgetType() === self::WIDGET_TYPE_SIDEBAR
        ) {
    ...
    {
        return array_merge(parent::defineCachedParams(), [self::PARAM_CATEGORY_ID]);
    }
