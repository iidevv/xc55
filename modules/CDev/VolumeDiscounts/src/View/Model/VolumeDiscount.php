...
namespace CDev\VolumeDiscounts\View\Model;
...
class VolumeDiscount extends \XLite\View\Model\AModel
{
    ...
    protected $schemaDefault = [
        'type'            => [
            self::SCHEMA_CLASS    => 'CDev\VolumeDiscounts\View\FormField\SelectDiscountType',
        ...
        'dateRangeBegin'  => [
            self::SCHEMA_CLASS => 'CDev\VolumeDiscounts\View\FormField\Date',
    ...
    protected function getDefaultModelObject()
    {
        $model = $this->getModelId()
            ? \XLite\Core\Database::getRepo('CDev\VolumeDiscounts\Model\VolumeDiscount')->find($this->getModelId())
            : null;

        return $model ?: new \CDev\VolumeDiscounts\Model\VolumeDiscount();
    }
    ...
    {
        return '\CDev\VolumeDiscounts\View\Form\VolumeDiscount';
    }
    ...
    protected function getErrorMessages()
    {
        if (!isset($this->errorMessages)) {
            ...
            if (!$this->errorMessages) {
                ...
                $similarDiscounts = \XLite\Core\Database::getRepo('CDev\VolumeDiscounts\Model\VolumeDiscount')->findSimilarDiscounts($currentDiscount);
