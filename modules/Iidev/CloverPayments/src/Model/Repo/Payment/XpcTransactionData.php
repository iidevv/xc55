...
namespace Iidev\CloverPayments\Model\Repo\Payment;
 ...
 */
class XpcTransactionData extends ARepo
{
    /**
     ...
     * @return void
     */
    protected function prepareCndCardId(QueryBuilder $queryBuilder, $value = null)
    {
        if ($value) {
     ...
     * @return void
     */
    protected function prepareCndProfileId(QueryBuilder $queryBuilder, $value = null)
    {
        if ($value) {
     ...
     * @return void
     */
    protected function prepareCndLogin(QueryBuilder $queryBuilder, $value = null)
    {
        if ($value) {
     ...
     * @return void
     */
    protected function prepareCndRechargesOnly(QueryBuilder $queryBuilder, $rechargesOnly = false)
    {
        if ($rechargesOnly) {
     ...
     * @return void
     */
    protected function prepareCndPaymentActive(QueryBuilder $queryBuilder, $paymentActive = false)
    {
        if ($paymentActive) {
     ...
     *
     * @return \Iidev\CloverPayments\Model\Payment\XpcTransactionData
     */
