...
class GenerateCategoryCommand extends Command
{
    ...
    protected function doGenerateCategories(SymfonyStyle $io, $suffix, $count, $maxDepth, $generateImage, $imagesGenerator, \XLite\Model\Category $parent = null, $depth = 1)
    {
        if (!$parent) {
        ...
        for ($i = 0; $i < $count; $i++) {
            ...
            if ($depth < $maxDepth) {
                $this->doGenerateCategories($io, $suffix . '_' . $i, $count, $maxDepth, $generateImage, $imagesGenerator, $category, $depth + 1);
            }
        }
