...
{
    public const COLUMN_GETTER    = 'getter';
    public const COLUMN_MULTIPLE  = 'multiple';
    public const COLUMN_FORMATTER = 'formatter';
    ...
    {
        return $i == 0 ? $this->buildPrimaryRow($dataset) : $this->buildSecondaryRow($dataset, $i);
    }
    ...
    protected function processColumns()
    {
        ...
        foreach ($this->columns as $name => $column) {
            $uname = \Includes\Utils\Converter::convertToUpperCamelCase($name);
    ...
    {
        if (
            $this->generator->getOptions()->charset != static::DEFAULT_CHARSET
