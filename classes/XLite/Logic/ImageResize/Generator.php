...
{
    public const MODEL_PRODUCT  = 'XLite\Model\Image\Product\Image';
    public const MODEL_CATEGORY = 'XLite\Model\Image\Category\Image';
    public const MODEL_LOGO     = 'XLite\Model\Image\Common\Logo';
    ...
    public static function getImageSizes($model = null, $code = null)
    {
        ...
        if ($model !== null && $code !== null) {
            $result = static::$imageSizesCache[$model][$code] ?? null;
        } else {
