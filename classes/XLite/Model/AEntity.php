...
abstract class AEntity extends \XLite\Base\SuperClass implements SerializableEntity
{
    ...
    public function getPreviousState()
    {
        if ($this->previousState === null) {
            $this->previousState = new \XLite\Core\CommonCell();
        }
    ...
    public function __get($name)
    {
        ...
        return $this->{'get' . \Includes\Utils\Converter::convertToUpperCamelCase($name)}();
    }
    ...
    {
        // Mutator method name
        return $this->{'set' . \Includes\Utils\Converter::convertToUpperCamelCase($name)}($value);
    }
    ...
    public function __call($method, array $args = [])
    {
        ...
        if ($result) {
            $property = \Includes\Utils\Converter::convertFromCamelCase($matches[2]);
            $result = $matches[1] === 'set'
    ...
    {
        return $this->getEntityState() === \Doctrine\ORM\UnitOfWork::STATE_DETACHED;
    }
    ...
    {
        return $this->getEntityState() === \Doctrine\ORM\UnitOfWork::STATE_MANAGED;
    }
    ...
    {
        return $this->{'get' . \Includes\Utils\Converter::convertToUpperCamelCase($this->getUniqueIdentifierName())}();
    }
    ...
    protected function processFile($file, $data, $properties)
    {
        ...
        if (isset($data['delete']) && $data['delete']) {
            ...
            if ($isSaved === false) {
                ...
                $errorMessage = $file->getLoadErrorMessage() ?: ['File can not be uploaded'];

                $file = null;
            } elseif ($isNewFile) {
                \XLite\Core\Database::getEM()->flush($file);
            }
        }
        ...
        if ($file) {
            ...
            if (
                ...
                $file->setStorageType(\XLite\Model\Base\Image::STORAGE_URL);
            }
            ...
            if (
                ...
                $bus->dispatch(new ResizeImage($file->getId(), get_class($file)));
            }
        }
