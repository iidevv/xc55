 ...
 * @ORM\Entity
 *
 * @ORM\Table  (name="attribute_values_checkbox_translations",
 *         indexes={
...
class AttributeValueCheckboxTranslation extends \XLite\Model\Base\Translation
{
     ...
     *
     * @ORM\ManyToOne (targetEntity="XLite\Model\AttributeValue\AttributeValueCheckbox", inversedBy="translations")
