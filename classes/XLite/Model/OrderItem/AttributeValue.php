 ...
 *
 * @ORM\Entity
 * @ORM\Table  (name="order_item_attribute_values")
 */
class AttributeValue extends \XLite\Model\AEntity
{
     ...
     *
     * @ORM\ManyToOne  (targetEntity="XLite\Model\OrderItem", inversedBy="attributeValues")
     ...
     *
     * @ORM\ManyToOne  (targetEntity="XLite\Model\AttributeValue\AttributeValueCheckbox")
     * @ORM\JoinColumn (name="attribute_value_checkbox_id", referencedColumnName="id", onDelete="SET NULL")
     */
     ...
     *
     * @ORM\ManyToOne  (targetEntity="XLite\Model\AttributeValue\AttributeValueSelect")
     * @ORM\JoinColumn (name="attribute_value_select_id", referencedColumnName="id", onDelete="SET NULL")
     */
     ...
     *
     * @ORM\ManyToOne  (targetEntity="XLite\Model\AttributeValue\AttributeValueText")
     * @ORM\JoinColumn (name="attribute_value_text_id", referencedColumnName="id", onDelete="SET NULL")
     */
