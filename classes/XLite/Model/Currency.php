...
class Currency extends \XLite\Model\Base\I18n
{
     ...
     *
     * @ORM\OneToMany (targetEntity="XLite\Model\Order", mappedBy="currency")
     */
    protected $orders;
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\OneToMany (targetEntity="XLite\Model\Country", mappedBy="currency", cascade={"all"})
     */
    protected $countries;
     ...
     * @var string
     *
     * @ORM\Column (type="string", options={"default" : "N"})
     */
     ...
     * @var \Doctrine\Common\Collections\Collection
     *
     * @ORM\OneToMany (targetEntity="XLite\Model\CurrencyTranslation", mappedBy="owner", cascade={"all"})
     */
