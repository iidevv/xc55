...
class MembershipsQuickData extends \XLite\Core\EventListener\Base\Countable
{
     ...
     * Generator
     *
     * @var \XLite\Logic\MembershipsQuickData\Generator
     */
    protected $generator;
     ...
     * Get items
     *
     * @return \XLite\Logic\MembershipsQuickData\Generator
     */
    protected function getItems()
    {
        if (!isset($this->generator)) {
            $this->generator = new \XLite\Logic\MembershipsQuickData\Generator(
                $this->record['options'] ?? []
            );
        }
