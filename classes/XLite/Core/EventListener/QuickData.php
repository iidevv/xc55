 ...
 * Export
 */
class QuickData extends \XLite\Core\EventListener\Base\Countable
{
    ...
    protected function getItems()
    {
        if (!isset($this->generator)) {
            $this->generator = new \XLite\Logic\QuickData\Generator(
                $this->record['options'] ?? []
            );
        }
    ...
    {
        if (!$this->getLength()) {
            $this->errors[] = static::t('There is no data to process.');
        }
    }
