...
/**
 * Assets represent a collection of css and js assets with a specific "interface", "zone" and index (relative position).
 */
class Assets
{
    /**
    ...
    public function __construct($assets, $index, $interface, $zone, $group)
    {
        $this->assets    = $assets;
        $this->index     = $index;
