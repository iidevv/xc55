...
class GD extends \XLite\Core\ImageOperator\AEngine
{
    ...
    protected static $types = [
        ...
        'image/bmp'           => 'wbmp',
        'image/png'           => 'png',
        Image::WEBP_MIME_TYPE => Image::WEBP_EXTENSION,
    ];
    ...
    {
        return static::$types[$mimeType] ?? null;
    }
    ...
    protected function processWebpWhileDoNotSupportWebp(): bool
    {
        ...
        if ($result) {
            $this->getLogger()->warning(
                'Installed GD version does not support WebP format. Thumbnails have not been generated, original image will be shown instead.',
                [
                    'Image' => $image->getName()
                ]
            );
    ...
    public function setImage($image)
    {
        ...
        $body = $image->getBody();
        $this->resource = $body && function_exists('imagecreatefromstring')
