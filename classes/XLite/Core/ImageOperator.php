...
{
    public const ENGINE_IMAGE_MAGICK = 'image_magick';
    public const ENGINE_GD           = 'gd';
    public const ENGINE_SIMPLE       = 'simple';
    ...
    public function resize($width = null, $height = null)
    {
        ...
        return ($width !== $image->getWidth() || $height !== $image->getHeight())
            ? [$width, $height, static::getEngine()->resize($width, $height)]
            : [$width, $height, false];
    }
    ...
    {
        return static::getEngine()->isWebpSupported();
    }

    /**
     * Get human-readable name for the current engine.
     */
    public static function getEngineName(): string
    {
        return static::getEngine()->getName();
    }
}
