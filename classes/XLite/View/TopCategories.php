 ...
 *
 * @ListChild (list="sidebar.first", zone="customer", weight="50")
 */
class TopCategories extends \XLite\View\SideBarBox
{
    ...
    public const DISPLAY_MODE_TREE = 'tree';
    public const DISPLAY_MODE_PATH = 'path';
    ...
    protected function assembleItemClassName($index, $count, $category)
    {
        ...
        if (!$category['hasSubcategories']) {
            $classes[] = 'leaf';
        } elseif ($this->getDisplayMode() != self::DISPLAY_MODE_LIST) {
