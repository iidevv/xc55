...
class Image extends \XLite\View\AView
{
    ...
    public const PARAM_MAX_WIDTH         = 'maxWidth';
    public const PARAM_MAX_HEIGHT        = 'maxHeight';
    public const PARAM_SIZE_ID           = 'sizeId';
    public const PARAM_CENTER_IMAGE      = 'centerImage';
    public const PARAM_VERTICAL_ALIGN    = 'verticalAlign';
    public const PARAM_USE_CACHE         = 'useCache';
    public const PARAM_USE_DEFAULT_IMAGE = 'useDefaultImage';
    public const PARAM_IMAGE_SIZE_TYPE   = 'imageSizeType';
    public const PARAM_LAZY_LOAD         = 'lazyLoad';
    public const PARAM_USE_TIMESTAMP     = 'useTimestamp';
    public const PARAM_RESIZE_IMAGE      = 'resizeImage';
     ...
     */
    public const DEFAULT_IMAGE_WIDTH  = 120;
    public const DEFAULT_IMAGE_HEIGHT = 120;
    ...
    public function setWidgetParams(array $params)
    {
        ...
        if (
            $this->getParam(self::PARAM_MAX_WIDTH) == 0
            && $this->getParam(self::PARAM_MAX_HEIGHT) == 0
            && $this->getParam(self::PARAM_IMAGE_SIZE_TYPE)
        ) {
            [$width, $height] = \XLite\Logic\ImageResize\Generator::getImageSizes(
    ...
    protected function checkDefaultImage()
    {
        return $this->getParam(self::PARAM_USE_DEFAULT_IMAGE)
               && \Includes\Utils\ConfigParser::getOptions(['images', 'default_image']);
    }
    ...
    {
        $vertical = ($this->getParam(self::PARAM_MAX_HEIGHT) - ($this->properties['height'] ?? 0)) / 2;
    ...
    protected function processDefaultImage()
    {
        ...
        [$this->properties['width'], $this->properties['height']] = \XLite\Core\ImageOperator::getCroppedDimensions(
