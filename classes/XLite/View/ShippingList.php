...
class ShippingList extends \XLite\View\AView
{
    ...
    {
        $rates = $this->getModifier()->getRates();

        usort($rates, static function ($rate1, $rate2) {
            return $rate1->getMethod()->getPosition() <=> $rate2->getMethod()->getPosition();
        });
     ...
     * @return int|null
     */
    protected function getSelectedMethodId(): ?int
    {
        return $this->getSelectedMethod() ? $this->getSelectedMethod()->getMethodId() : null;
    }
