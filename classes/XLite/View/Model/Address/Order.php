...
class Order extends \XLite\View\Model\Address\Address
{
     ...
     */
    public const PARAM_ADDRESS_TYPE = 'addressType';
    ...
    public function getRequestAddressId()
    {
        ...
        return $this->getParam(static::PARAM_ADDRESS_TYPE) == 'shipping'
    ...
    protected function getDefaultModelObject()
    {
        if (!isset($this->address)) {
            if ($this->getRequestAddressId()) {
                ...
                if ($this->getParam(static::PARAM_ADDRESS_TYPE) == 'shipping') {
    ...
    protected function getModelObjectValue($name)
    {
        ...
        if (\XLite\Core\Request::getInstance()->$prefix) {
            ...
            $value = $data[$pureName] ?? parent::getModelObjectValue($name);
        } else {
