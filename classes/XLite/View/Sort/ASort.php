...
abstract class ASort extends \XLite\View\AView
{
    ...
    public const PARAM_SORT_CRITERIA = 'sortCriteria';
    ...
    public function isSortOrderAsc()
    {
        ...
        return empty($cell['sortOrder']) || $cell['sortOrder'] == 'asc';
    }
    ...
    protected function defineWidgetParams()
    {
        ...
        $this->widgetParams += [
            self::PARAM_PARAMS        => new \XLite\Model\WidgetParam\TypeCollection('URL params', []),
            self::PARAM_SORT_CRITERIA => new \XLite\Model\WidgetParam\TypeCollection('Sort criteria', []),
            self::PARAM_CELL          => new \XLite\Model\WidgetParam\TypeCollection('List conditions cell', []),
        ];
    }
