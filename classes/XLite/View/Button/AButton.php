...
abstract class AButton extends \XLite\View\AView
{
     ...
     */
    public const PARAM_NAME     = 'buttonName';
    public const PARAM_VALUE    = 'value';
    public const PARAM_LABEL    = 'label';
    public const PARAM_TITLE    = 'title';
    public const PARAM_STYLE    = 'style';
    public const PARAM_DISABLED = 'disabled';
    public const PARAM_ID       = 'id';
    public const PARAM_ATTRIBUTES = 'attributes';
    public const PARAM_BTN_SIZE   = 'button-size';
    public const PARAM_BTN_TYPE   = 'button-type';
    public const PARAM_ICON_STYLE = 'icon-style';

    public const BTN_SIZE_DEFAULT = 'btn-default';
