...
class ImageUpload extends \XLite\View\AView
{
    ...
    public const PARAM_ACTION_NAME = 'actionName';
    public const PARAM_FORM_NAME = 'formName';
    ...
    {
        return $this->getParam(self::PARAM_OBJECT)->get($this->getParam(self::PARAM_FIELD))->getDefaultSource() == 'F';
    }
}
