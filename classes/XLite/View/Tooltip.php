...
class Tooltip extends \XLite\View\AView
{
    ...
    public const PARAM_WIDGET        = 'helpWidget';
    public const PARAM_PLACEMENT     = 'placement';
    public const PARAM_DELAY         = 'delay';
    public const PARAM_DELAY_SHOW    = 'delayShow';
    public const PARAM_CLASS         = 'className';
    public const PARAM_CAPTION       = 'caption';
    public const PARAM_IS_IMAGE_TAG  = 'isImageTag';
    public const PARAM_IMAGE_CLASS   = 'imageClass';
    public const PARAM_CLEAR_AFTER   = 'clear';
    public const PARAM_HELP_ID       = 'helpId';
    public const PARAM_CONTAINER     = 'container';
    public const PARAM_KEEP_ON_HOVER = 'keepOnHover';
    public const PARAM_IS_HTML_MODE  = 'isHtmlMode';

    public const ATTR_CLASS = 'class';
    public const ATTR_ID    = 'id';

    public const CAPTION_CSS_CLASS = 'tooltip-caption';
