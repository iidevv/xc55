...
{
    public const MODE_UPDATE_AND_CREATE = 'UC';
    public const MODE_UPDATE_ONLY       = 'U';
    public const MODE_CREATE_ONLY       = 'C';
    ...
    {
        return static::t('https://support.x-cart.com/en/collections/2590836-import-export');
    }
