...
abstract class AModel extends \XLite\View\FormField\AFormField
{
     ...
     * Widget param names
     */
    public const PARAM_MIN_COUNT               = 'min_count';
    public const PARAM_EMPTY_PHRASE            = 'empty_phrase';
    public const PARAM_EMPTY_MODEL_DEFINITION  = 'empty_model_definition';
    public const PARAM_GETTER                  = 'getter';
    public const PARAM_PLACEHOLDER             = 'placeholder';
    public const PARAM_IS_MODEL_REQUIRED       = 'is_model_required';
    public const PARAM_SPACER_PATH             = 'spacer_path';
    ...
    protected function defineWidgetParams()
    {
        ...
        $this->widgetParams += [
            static::PARAM_MIN_COUNT => new \XLite\Model\WidgetParam\TypeInt(
                'Minimum symbols count after which the search will be permitted',
                $this->getDefaultMinCount(),
                false
            ),
            static::PARAM_EMPTY_PHRASE => new \XLite\Model\WidgetParam\TypeString(
                'Text for the empty list',
                $this->getDefaultEmptyPhrase(),
                false
            ),
            static::PARAM_EMPTY_MODEL_DEFINITION => new \XLite\Model\WidgetParam\TypeString(
                'Text when no model is selected',
                $this->getDefaultEmptyModelDefinition(),
                false
            ),
            static::PARAM_GETTER => new \XLite\Model\WidgetParam\TypeString(
                'URL which will be the getter of the search objects',
                $this->getDefaultGetter(),
                false
            ),
            ...
            static::PARAM_SPACER_PATH => new \XLite\Model\WidgetParam\TypeString(
                'Spacer image path',
                $this->getDefaultSpacerPath(),
                false
            ),
        ];
    }
     ...
     * @return string
     */
    protected function getDefaultSpacerPath()
    {
    ...
    protected function getCommentedData()
    {
        return [
            ...
            static::PARAM_SPACER_PATH => $this->getParam(static::PARAM_SPACER_PATH),
        ];
    }
