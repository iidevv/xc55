...
{
    public const PARAM_BUTTON_LABEL   = 'buttonLabel';
    public const PARAM_REMOVE_BUTTON  = 'removeButton';
    public const PARAM_OBJECT         = \XLite\View\Button\FileSelector::PARAM_OBJECT;
    public const PARAM_OBJECT_ID      = \XLite\View\Button\FileSelector::PARAM_OBJECT_ID;
    public const PARAM_FILE_OBJECT    = \XLite\View\Button\FileSelector::PARAM_FILE_OBJECT;
    public const PARAM_FILE_OBJECT_ID = \XLite\View\Button\FileSelector::PARAM_FILE_OBJECT_ID;
    ...
    public function setWidgetParams(array $params)
    {
        ...
        if ($this->getWidgetParams(static::PARAM_FILE_OBJECT_ID)->value !== 0) {
