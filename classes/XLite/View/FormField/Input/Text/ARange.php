...
{
    public const PARAM_SEPARATOR = 'separator';

    /**
     * Default separator
     */
    public const DEFAULT_SEPARATOR = '&minus;';
    ...
    protected function getBeginValue()
    {
        ...
        return $value[0] ?? $this->getDefaultBeginValue();
    }
    ...
    protected function getEndValue()
    {
        ...
        return $value[1] ?? $this->getDefaultEndValue();
    }
