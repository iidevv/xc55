...
class ContactUsComment extends \XLite\View\FormField\AFormField
{
    ...
    {
        if (
            Manager::getRegistry()->getModule('CDev', 'ContactUs')
            && Manager::getRegistry()->isModuleEnabled('CDev', 'ContactUs')
        ) {
            return Manager::getRegistry()->getModuleSettingsUrl('CDev', 'ContactUs');
        }
