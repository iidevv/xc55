...
class QuantityBox extends \XLite\View\Product\AProduct
{
    ...
    public const PARAM_IS_CART_PAGE = 'isCartPage';
    public const PARAM_FORCE_VALUE  = 'forceValue';
    public const PARAM_MAX_VALUE    = 'maxValue';
    public const PARAM_MOUSE_WHEEL_CTRL = 'mouseWheelCtrl';
    ...
    *
    ...
    protected function getMaxQuantity()
    {
        ...
        return $maxValue ?? $this->getProduct()->getAvailableAmount() - $this->getProduct()->getItemsInCart() + $orderItemsAmount;
    }
