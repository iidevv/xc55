...
abstract class AAttributes extends \XLite\View\AView
{
    ...
    public const PARAM_PRODUCT_CLASS   = 'productClass';
    public const PARAM_PERSONAL_ONLY   = 'personalOnly';
    public const PARAM_HIDDEN_ONLY     = 'hiddenOnly';
    public const PARAM_PROPERTIES_ONLY = 'propertiesOnly';
    ...
    public function getTitle()
    {
        if ($this->getAttributeGroup()) {
            ...
            $result = static::t('{{name}} attributes', ['name' => $this->getProductClass()->getName()]);
        } elseif ($this->getPersonalOnly()) {
            $result = static::t('Product-Specific attributes');
        } elseif ($this->getPropertiesOnly()) {
            $result = static::t('Sort Settings');
    ...
    protected function defineWidgetParams()
    {
        ...
        $this->widgetParams += [
            ...
            static::PARAM_PROPERTIES_ONLY => new \XLite\Model\WidgetParam\TypeBool('Properties only', false)
        ];
    }
    ...
    /**
     * Get properties only flag
     *
     * @return boolean
     */
    protected function getPropertiesOnly()
    {
        return $this->getParam(static::PARAM_PROPERTIES_ONLY);
    }
