...
class Search extends \XLite\View\ItemsList\Product\Customer\ACustomer
{
    ...
    public const PARAM_SEARCH_IN_SUBCATS = 'searchInSubcats';
    public const PARAM_INCLUDING         = 'including';
    public const PARAM_BY_TITLE          = 'by_title';
    public const PARAM_BY_DESCR          = 'by_descr';
    public const PARAM_BY_SKU            = 'by_sku';

    /**
     * Allowed sort criteria
     */
    public const SORT_BY_MODE_DEFAULT = 'p.product_id';

    /**
     * Widget target
     */
    public const WIDGET_TARGET = 'search';
    ...
    {
        return static::t('X products found', ['count' => $this->getItemsCount()]);
    }
    ...
    {
        return parent::getCommonParams() + ['mode' => 'search'];
    }
    ...
    {
        return $param !== \XLite\View\Pager\APager::PARAM_PAGE_ID ? parent::getSavedRequestParam($param) : null;
    }
