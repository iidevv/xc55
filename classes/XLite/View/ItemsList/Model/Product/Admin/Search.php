...
class Search extends \XLite\View\ItemsList\Model\Product\Admin\AAdmin
{
    ...
    public const PARAM_INVENTORY         = 'inventory';
    ...
    protected function getFormParams()
    {
        ...
        if (\XLite\Core\Request::getInstance()->{static::PARAM_INVENTORY} === 'low') {
    ...
    protected function getSearchCondition()
    {
        ...
        if ($result->{$enabledFieldName} && $result->{$enabledFieldName}->getValue()) {
            $booleanValue = $result->{$enabledFieldName}->getValue() === 'enabled';
    ...
    {
        return [
            'data-widget' => 'XLite\View\ItemsList\Model\Product\Admin\Search'
        ];
    }
}
