...
class ProductSelection extends \XLite\View\ItemsList\Model\Table
{
     ...
     */
    public const SORT_BY_NAME  = 'translations.name';
    public const SORT_BY_SKU   = 'p.sku';
    public const SORT_BY_PRICE = 'p.price';
    public const SORT_BY_AMOUNT = 'p.amount';
    ...
    public const PARAM_SEARCH_PANEL_CLASS = 'searchPanelClass';
