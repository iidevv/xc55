...
class State extends \XLite\View\ItemsList\Model\Table
{
    ...
    protected function defineColumns()
    {
        ...
        if ($this->getValidCountry()->hasRegions()) {
            $columns['region'] =  [
                static::COLUMN_NAME   => \XLite\Core\Translation::lbl('Region'),
    ...
    {
        return \XLite\Core\Translation::lbl('X states have been removed', ['count' => $count]);
    }
    ...
    {
        return \XLite\Core\Translation::lbl('X states have been successfully created', ['count' => $count]);
    }
