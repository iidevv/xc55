...
class Labels extends \XLite\View\ItemsList\Model\Table
{
    ...
    protected function getSearchCondition()
    {
        ...
        $codes = [static::getDefaultLanguage(), $this->getLanguageCode()];
        ...
        $result->{\XLite\Model\Repo\LanguageLabel::P_ORDER_BY} = ['l.name', 'ASC'];
    ...
    {
        return \XLite\Core\Translation::lbl('X language labels have been removed', ['count' => $count]);
    }
    ...
    protected function isSeveralLanguagesExists()
    {
        ...
        return 1 < count($languages) || $this->getLanguageCode() != 'en';
    }
