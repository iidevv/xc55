...
class Info extends \XLite\View\FormModel\AFormModel
{
    ...
    protected function defineFields()
    {
        ...
        $schema = [
            ...
            'shipping'             => [
                'requires_shipping_status' => [
                    'label'                => static::t('Requires shipping'),
                    'help'                 => static::t('Keep “Requires shipping“ turned off, if the product is intangible and is not shipped.'),
                    'type'                 => 'XLite\View\FormModel\Type\SwitcherType',
                    'position'             => 100,
                ],
                'weight'            => [
                ...
                'dimensions'       => [
                    'label'     => static::t('Dimensions') . ' (' . Translation::translateDimSymbol() . ')',
        ...
        if ((bool)$this->getDataObject()->default->identity) {
