...
class Minicart extends \XLite\View\SideBarBox
{
     ...
     */
    public const DISPLAY_MODE_HORIZONTAL = 'horizontal';

    /**
     * Number of cart items to display by default
     */
    public const ITEMS_TO_DISPLAY = 3;
    ...
    protected function getItemsList()
    {
        return array_reverse(
            array_slice(
                ...
                -$this->getCountCartItemsToDisplay()
            )
        );
    }
    ...
    {
        return $this->getCountCartItemsToDisplay() < $this->getCart()->countItems();
    }
    ...
    {
        return ['Total' => $this->getCart()->getTotal()];
    }
    ...
    {
        $attributes = [
            'class' => ['internal-popup', 'items-list'],
        ];
