...
class Order extends \XLite\Controller\Admin\AAdmin
{
    ...
    public function getTitle()
    {
        ...
        } elseif (ltrim(\XLite\Core\Request::getInstance()->widget, '\\') === 'XLite\View\Address\OrderModify') {
            $result = static::t('Customer information');
        } elseif (ltrim(\XLite\Core\Request::getInstance()->widget, '\\') === 'XLite\View\SelectAddressOrder') {
            $result = static::t('Pick address from address book');
        } elseif (ltrim(\XLite\Core\Request::getInstance()->widget, '\\') === 'XLite\View\PaymentMethodData') {
            $paymentMethod = null;
