...
class Product extends \XLite\Controller\Admin\ACL\Catalog
{
     ...
     * @var array
     */
    protected $params = ['target', 'id', 'product_id', 'page', 'backURL'];
     ...
     */
    public function getInventoryModelForm(array $params = [])
    {
    ...
    protected function doActionUpdate()
    {
        ...
        if ($form->isValid()) {
            ...
            if ($product->getProductId()) {
                Database::getEM()->getUnitOfWork()->scheduleForUpdate($product);
            }
    ...
    protected function doActionUpdateProductClass()
    {
        ...
        if (\XLite\Core\Request::getInstance()->productClass == -1) {
