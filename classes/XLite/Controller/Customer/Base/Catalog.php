...
abstract class Catalog extends \XLite\Controller\Customer\ACustomer
{
    ...
    {
        return $this->buildURL('category', '', ['category_id' => $category->getCategoryId()]);
    }
    ...
    {
        return ['shippingMethodsHash', 'paymentMethodsHash', 'shippingMethodId', 'paymentMethodId', 'shippingTotal'];
    }
}
