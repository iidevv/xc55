...
class AccessControl extends \XLite\Controller\Customer\ACustomer
{
     ...
     */
    public const TIME_OF_LOCK_ACCESS = 120;

    /**
     * Max count of login attempt
     */
    public const MAX_COUNT_OF_ACCESS_ATTEMPTS = 1;

    /**
     * Max count of login attempt
     */
    public const MAX_COUNT_OF_RESEND_ATTEMPTS = 1;

    /**
     * Prefix for tmp vars storage access attempts
     */
    public const TMP_VAR_LOCK_IP_PREFIX = 'access_control_ip_';
