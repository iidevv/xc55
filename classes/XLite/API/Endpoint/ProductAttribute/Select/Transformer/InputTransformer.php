...
use XLite\API\Endpoint\ProductAttribute\Select\DTO\ProductAttributeSelectInput as InputDTO;
...
class InputTransformer implements DataTransformerInitializerInterface, InputTransformerInterface
{
    ...
    public function transform($object, string $to, array $context = []): Model
    {
        ...
        $entity->setDisplayMode($object->displayMode);
    ...
    public function initialize(string $inputClass, array $context = [])
    {
        ...
        $input->displayMode = $entity->getDisplayMode();
