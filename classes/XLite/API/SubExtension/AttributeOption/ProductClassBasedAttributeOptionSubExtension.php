...
class ProductClassBasedAttributeOptionSubExtension implements CollectionSubExtensionInterface, ItemSubExtensionInterface
{
    ...
    public function __construct(string $attributeType, array $operationNames, string $pathPrefix, EntityManagerInterface $entityManager)
    {
    ...
    protected function addWhere(QueryBuilder $queryBuilder, array $context): void
    {
        ...
        $queryBuilder
            ...
            ->andWhere('attribute.productClass = :classId')
            ->andWhere('attribute.product IS NULL')
